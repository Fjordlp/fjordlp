...
// =====================================================================
const LANGUAGES = [
    { code: 'no', cc: 'no', flag: '🇳🇴', native: 'Norsk', name: { uk: 'Норвезька', en: 'Norwegian', ru: 'Норвежский' }, builtin: true },
    { code: 'en', cc: 'gb', flag: '🇬🇧', native: 'English', name: { uk: 'Англійська', en: 'English', ru: 'Английский' }, builtin: true },
    { code: 'de', cc: 'de', flag: '🇩🇪', native: 'Deutsch', name: { uk: 'Німецька', en: 'German', ru: 'Немецкий' }, builtin: false },
    { code: 'es', cc: 'es', flag: '🇪🇸', native: 'Español', name: { uk: 'Іспанська', en: 'Spanish', ru: 'Испанский' }, builtin: false },
    { code: 'fr', cc: 'fr', flag: '🇫🇷', native: 'Français', name: { uk: 'Французька', en: 'French', ru: 'Французский' }, builtin: false },
    { code: 'it', cc: 'it', flag: '🇮🇹', native: 'Italiano', name: { uk: 'Італійська', en: 'Italian', ru: 'Итальянский' }, builtin: false },
    { code: 'pt', cc: 'pt', flag: '🇵🇹', native: 'Português', name: { uk: 'Португальська', en: 'Portuguese', ru: 'Португальский' }, builtin: false },
    { code: 'pl', cc: 'pl', flag: '🇵🇱', native: 'Polski', name: { uk: 'Польська', en: 'Polish', ru: 'Польский' }, builtin: false },
    { code: 'sv', cc: 'se', flag: '🇸🇪', native: 'Svenska', name: { uk: 'Шведська', en: 'Swedish', ru: 'Шведский' }, builtin: false },
    { code: 'nl', cc: 'nl', flag: '🇳🇱', native: 'Nederlands', name: { uk: 'Нідерландська', en: 'Dutch', ru: 'Нидерландский' }, builtin: false },
    { code: 'ja', cc: 'jp', flag: '🇯🇵', native: '日本語', name: { uk: 'Японська', en: 'Japanese', ru: 'Японский' }, builtin: false },
    { code: 'tr', cc: 'tr', flag: '🇹🇷', native: 'Türkçe', name: { uk: 'Турецька', en: 'Turkish', ru: 'Турецкий' }, builtin: false },
    { code: 'da', cc: 'dk', flag: '🇩🇰', native: 'Dansk', name: { uk: 'Данська', en: 'Danish', ru: 'Датский' }, builtin: false },
    { code: 'fi', cc: 'fi', flag: '🇫🇮', native: 'Suomi', name: { uk: 'Фінська', en: 'Finnish', ru: 'Финский' }, builtin: false },
    { code: 'is', cc: 'is', flag: '🇮🇸', native: 'Íslenska', name: { uk: 'Ісландська', en: 'Icelandic', ru: 'Исландский' }, builtin: false },
    { code: 'el', cc: 'gr', flag: '🇬🇷', native: 'Ελληνικά', name: { uk: 'Грецька', en: 'Greek', ru: 'Греческий' }, builtin: false },
    { code: 'cs', cc: 'cz', flag: '🇨🇿', native: 'Čeština', name: { uk: 'Чеська', en: 'Czech', ru: 'Чешский' }, builtin: false },
    { code: 'sk', cc: 'sk', flag: '🇸🇰', native: 'Slovenčina', name: { uk: 'Словацька', en: 'Slovak', ru: 'Словацкий' }, builtin: false },
    { code: 'ro', cc: 'ro', flag: '🇷🇴', native: 'Română', name: { uk: 'Румунська', en: 'Romanian', ru: 'Румынский' }, builtin: false },
    { code: 'hu', cc: 'hu', flag: '🇭🇺', native: 'Magyar', name: { uk: 'Угорська', en: 'Hungarian', ru: 'Венгерский' }, builtin: false },
    { code: 'bg', cc: 'bg', flag: '🇧🇬', native: 'Български', name: { uk: 'Болгарська', en: 'Bulgarian', ru: 'Болгарский' }, builtin: false },
    { code: 'hr', cc: 'hr', flag: '🇭🇷', native: 'Hrvatski', name: { uk: 'Хорватська', en: 'Croatian', ru: 'Хорватский' }, builtin: false },
    { code: 'uk', cc: 'ua', flag: '🇺🇦', native: 'Українська', name: { uk: 'Українська', en: 'Ukrainian', ru: 'Украинский' }, builtin: false },
    { code: 'ru', cc: 'ru', flag: '🇷🇺', native: 'Русский', name: { uk: 'Російська', en: 'Russian', ru: 'Русский' }, builtin: false },
    { code: 'zh', cc: 'cn', flag: '🇨🇳', native: '中文', name: { uk: 'Китайська', en: 'Chinese', ru: 'Китайский' }, builtin: false },
    { code: 'ko', cc: 'kr', flag: '🇰🇷', native: '한국어', name: { uk: 'Корейська', en: 'Korean', ru: 'Корейский' }, builtin: false },
    { code: 'ar', cc: 'sa', flag: '🇸🇦', native: 'العربية', name: { uk: 'Арабська', en: 'Arabic', ru: 'Арабский' }, builtin: false },
    { code: 'hi', cc: 'in', flag: '🇮🇳', native: 'हिन्दी', name: { uk: 'Гінді', en: 'Hindi', ru: 'Хинди' }, builtin: false },
    { code: 'vi', cc: 'vn', flag: '🇻🇳', native: 'Tiếng Việt', name: { uk: 'В\'єтнамська', en: 'Vietnamese', ru: 'Вьетнамский' }, builtin: false },
    { code: 'th', cc: 'th', flag: '🇹🇭', native: 'ไทย', name: { uk: 'Тайська', en: 'Thai', ru: 'Тайский' }, builtin: false },
    { code: 'id', cc: 'id', flag: '🇮🇩', native: 'Bahasa Indonesia', name: { uk: 'Індонезійська', en: 'Indonesian', ru: 'Индонезийский' }, builtin: false },
];
...
// =====================================================================
//  РЕНДЕР ПРАПОРІВ — БЕЗ EMOJI (фікс "NO"/"PL" замість прапора в Edge)
// =====================================================================
// Проблема: emoji-прапори (🇳🇴, 🇵🇱...) — це пара regional-indicator
// символів. Windows-шрифт Segoe UI Emoji до недавнього часу (і досі в
// частині збірок/версій Edge) не "склеює" їх у зображення прапора, а
// малює як два літерні квадратики — на вигляд це і є той самий "NO"
// чи "PL" текст, про який мова. Рішення — не покладатись на emoji-фонт
// системи, а рендерити прапор як SVG-іконку з бібліотеки flag-icons
// (підключена в index.html через CDN), яка виглядає однаково на всіх
// ОС/браузерах. Поле `cc` у LANGUAGES — це ISO 3166-1 alpha-2 код
// країни для цієї бібліотеки (напр. 'no', 'pl', 'gb'...).
function flagIconHtml(code, opts) {
    const lang = getLanguage(code);
    const size = (opts && opts.size) || '1.15em';
    const radius = (opts && opts.radius) || '3px';
    return `<span class="fi fi-${lang.cc} flag-icon" title="${lang.native}" ` +
        `aria-label="${lang.native}" role="img" ` +
        `style="display:inline-block;width:${size};height:${size};border-radius:${radius};` +
        `background-size:cover;background-position:center;vertical-align:-0.15em;flex-shrink:0;"></span>`;
}
