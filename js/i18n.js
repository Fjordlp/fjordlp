...
const UI_STRINGS = {
    uk: {
        ...
        nav_tests: 'Тести', nav_grammar: 'Граматика', nav_books: '📚 Книги', nav_lessons: '📖 Уроки', nav_story: '🧌 Пригода', nav_troll: 'Тролль',
        h_lessons: 'Уроки', lessons_intro: 'Проходь уроки по черзі — кожен наступний відкривається після того, як пройдеш попередній.', lessons_empty: 'Для цієї мови ще немає уроків. Загляньте пізніше!', lesson_n_label: 'Урок {n}', lessons_not_found: 'Урок не знайдено', lessons_locked_title: 'Урок ще закритий', lessons_locked_desc: 'Спочатку пройдіть попередній урок, щоб відкрити цей.', lesson_complete_btn: 'Позначити урок пройденим', lesson_complete_toast: 'Урок пройдено! +15 XP', lesson_already_done: 'Цей урок уже пройдено.',
        test_history_title: 'Історія тестів', back_to_profile: 'До профілю', th_total: 'Тестів пройдено', th_avg: 'Середній бал', th_best: 'Найкращий', th_worst: 'Найгірший', th_filter_all: 'Усі', th_clear: 'Очистити історію', th_empty_title: 'Історія порожня', th_empty_desc: 'Пройдіть перший тест, щоб побачити тут результати.', th_your_answer: 'Ваша відповідь', th_correct_answer: 'Правильна', th_clear_confirm: 'Видалити всю історію тестів? Це незворотно.', th_cleared_toast: 'Історію очищено',
        ...
        pronounce_btn: 'Сказати вголос', pronounce_correct: '✅ Чудова вимова!', pronounce_close: '🟡 Близько, ще трохи практики',
        pronounce_wrong: '🔴 Спробуй ще раз', pronounce_no_speech: '🤔 Нічого не почув(ла) — спробуй ще', pronounce_error: '⚠️ Мікрофон недоступний',
        pronounce_unsupported: 'Розпізнавання мовлення не підтримується цим браузером',
        story_title: 'Хроніки Тролля', story_intro: 'Особиста пригода, яка пишеться саме для тебе — Троль складає текст переважно зі слів, які ти вже знаєш, і трохи нових.',
        story_empty_desc: 'Троль чекає, поки ти будеш готовий вирушити в пригоду.', story_start_btn: 'Почати пригоду',
        story_generating: 'Троль складає наступний розділ…', story_chapters_so_far: 'Попередні розділи ({n})',
        story_new_words_label: 'Нові слова (уже додані в картки)', story_continue_btn: 'Далі', story_continue_generic: 'Продовжити', story_listen_btn: 'Прослухати розділ',
        story_retry_btn: 'Спробувати ще раз', story_error_rate_limit: 'забагато запитів підряд — зачекай хвилину',
        story_chapters_today: 'Розділів сьогодні: {n}', story_restart_btn: 'Почати нову пригоду',
        story_restart_confirm: 'Почати нову пригоду? Поточний сюжет буде забуто (слова у твоїй колоді карток залишаться).',
        story_xp_toast: '+{xp} XP за розділ!',
        ...
        h_courses: 'Уроки', courses_intro: 'Структуровані курси, які проведуть тебе від абсолютного нуля до впевнених базових речень — крок за кроком, урок за уроком.',
        courses_empty: 'Поки що немає курсів для цієї мови. Спробуй іншу мову або зазирни пізніше.',
        courses_not_found: 'Курс або урок не знайдено.', courses_lesson_n: 'Урок {n}',
        courses_back_to_library: 'До курсів', courses_prev_lesson: 'Попередній урок', courses_next_lesson: 'Наступний урок',
        courses_lesson_done: 'Пройдено', courses_mark_done: 'Позначити пройденим', courses_finish_btn: 'Завершити курс',
        courses_xp_toast: '+10 XP за урок!', courses_progress: 'Пройдено {done} з {total} уроків', courses_lessons_count: '{total} уроків',
        courses_table_head_target: 'Мовою вивчення', courses_table_head_uk: 'Українською',
    ...
    en: {
        ...
        nav_tests: 'Tests', nav_grammar: 'Grammar', nav_books: '📚 Books', nav_lessons: '📖 Lessons', nav_story: '🧌 Adventure', nav_troll: 'Troll',
        h_lessons: 'Lessons', lessons_intro: 'Go through the lessons in order — each next one unlocks once you finish the previous.', lessons_empty: "There aren't any lessons for this language yet. Check back later!", lesson_n_label: 'Lesson {n}', lessons_not_found: 'Lesson not found', lessons_locked_title: 'This lesson is still locked', lessons_locked_desc: 'Finish the previous lesson first to unlock this one.', lesson_complete_btn: 'Mark lesson as done', lesson_complete_toast: 'Lesson complete! +15 XP', lesson_already_done: "You've already completed this lesson.",
        test_history_title: 'Test History', back_to_profile: 'Back to profile', th_total: 'Tests taken', th_avg: 'Average score', th_best: 'Best', th_worst: 'Worst', th_filter_all: 'All', th_clear: 'Clear history', th_empty_title: 'No history yet', th_empty_desc: 'Take your first test to see results here.', th_your_answer: 'Your answer', th_correct_answer: 'Correct', th_clear_confirm: 'Delete all test history? This cannot be undone.', th_cleared_toast: 'History cleared',
        ...
        pronounce_btn: 'Say it out loud', pronounce_correct: '✅ Great pronunciation!', pronounce_close: '🟡 Close, keep practicing',
        pronounce_wrong: '🔴 Try again', pronounce_no_speech: "🤔 Didn't catch that — try again", pronounce_error: '⚠️ Microphone unavailable',
        pronounce_unsupported: "Speech recognition isn't supported in this browser",
        story_title: "Troll's Chronicles", story_intro: 'A personal adventure written just for you — the Troll builds the text mostly from words you already know, plus a few new ones.',
        story_empty_desc: 'The Troll is waiting for you to set off on an adventure.', story_start_btn: 'Start the adventure',
        story_generating: 'The Troll is writing the next chapter…', story_chapters_so_far: 'Previous chapters ({n})',
        story_new_words_label: 'New words (already added to your cards)', story_continue_btn: 'Next', story_continue_generic: 'Continue', story_listen_btn: 'Listen to chapter',
        story_retry_btn: 'Try again', story_error_rate_limit: 'too many requests in a row — wait a minute',
        story_chapters_today: 'Chapters today: {n}', story_restart_btn: 'Start a new adventure',
        story_restart_confirm: 'Start a new adventure? The current storyline will be forgotten (words already in your deck stay put).',
        story_xp_toast: '+{xp} XP for the chapter!',
        ...
        h_courses: 'Lessons', courses_intro: 'Structured courses that take you from absolute zero to confident basic sentences — step by step, lesson by lesson.',
        courses_empty: 'No courses for this language yet. Try another language or check back later.',
        courses_not_found: 'Course or lesson not found.', courses_lesson_n: 'Lesson {n}',
        courses_back_to_library: 'Back to courses', courses_prev_lesson: 'Previous lesson', courses_next_lesson: 'Next lesson',
        courses_lesson_done: 'Done', courses_mark_done: 'Mark as done', courses_finish_btn: 'Finish course',
        courses_xp_toast: '+10 XP for the lesson!', courses_progress: '{done} of {total} lessons done', courses_lessons_count: '{total} lessons',
        courses_table_head_target: 'Target language', courses_table_head_uk: 'Ukrainian',
    ...
    ru: {
        ...
        nav_tests: 'Тесты', nav_grammar: 'Грамматика', nav_books: '📚 Книги', nav_lessons: '📖 Уроки', nav_story: '🧌 Приключение', nav_troll: 'Тролль',
        h_lessons: 'Уроки', lessons_intro: 'Проходи уроки по очереди — каждый следующий открывается после того, как пройдёшь предыдущий.', lessons_empty: 'Для этого языка пока нет уроков. Загляните позже!', lesson_n_label: 'Урок {n}', lessons_not_found: 'Урок не найден', lessons_locked_title: 'Урок ещё закрыт', lessons_locked_desc: 'Сначала пройдите предыдущий урок, чтобы открыть этот.', lesson_complete_btn: 'Отметить урок пройденным', lesson_complete_toast: 'Урок пройден! +15 XP', lesson_already_done: 'Этот урок уже пройден.',
        test_history_title: 'История тестов', back_to_profile: 'К профилю', th_total: 'Тестов пройдено', th_avg: 'Средний балл', th_best: 'Лучший', th_worst: 'Худший', th_filter_all: 'Все', th_clear: 'Очистить историю', th_empty_title: 'История пуста', th_empty_desc: 'Пройдите первый тест, чтобы увидеть здесь результаты.', th_your_answer: 'Ваш ответ', th_correct_answer: 'Правильный', th_clear_confirm: 'Удалить всю историю тестов? Это необратимо.', th_cleared_toast: 'История очищена',
        ...
        pronounce_btn: 'Сказать вслух', pronounce_correct: '✅ Отличное произношение!', pronounce_close: '🟡 Близко, ещё немного практики',
        pronounce_wrong: '🔴 Попробуй ещё раз', pronounce_no_speech: '🤔 Ничего не услышал(а) — попробуй ещё', pronounce_error: '⚠️ Микрофон недоступен',
        pronounce_unsupported: 'Распознавание речи не поддерживается этим браузером',
        story_title: 'Хроники Тролля', story_intro: 'Личное приключение, которое пишется именно для тебя — Тролль составляет текст в основном из слов, которые ты уже знаешь, и немного новых.',
        story_empty_desc: 'Тролль ждёт, пока ты будешь готов отправиться в приключение.', story_start_btn: 'Начать приключение',
        story_generating: 'Тролль пишет следующую главу…', story_chapters_so_far: 'Предыдущие главы ({n})',
        story_new_words_label: 'Новые слова (уже добавлены в карточки)', story_continue_btn: 'Далее', story_continue_generic: 'Продолжить', story_listen_btn: 'Прослушать главу',
        story_retry_btn: 'Попробовать снова', story_error_rate_limit: 'слишком много запросов подряд — подожди минуту',
        story_chapters_today: 'Глав сегодня: {n}', story_restart_btn: 'Начать новое приключение',
        story_restart_confirm: 'Начать новое приключение? Текущий сюжет будет забыт (слова в твоей колоде карточек останутся).',
        story_xp_toast: '+{xp} XP за главу!',
        ...
        h_courses: 'Уроки', courses_intro: 'Структурированные курсы, которые проведут тебя от абсолютного нуля до уверенных базовых предложений — шаг за шагом, урок за уроком.',
        courses_empty: 'Пока нет курсов для этого языка. Попробуй другой язык или загляни позже.',
        courses_not_found: 'Курс или урок не найден.', courses_lesson_n: 'Урок {n}',
        courses_back_to_library: 'К курсам', courses_prev_lesson: 'Предыдущий урок', courses_next_lesson: 'Следующий урок',
        courses_lesson_done: 'Пройдено', courses_mark_done: 'Отметить пройденным', courses_finish_btn: 'Завершить курс',
        courses_xp_toast: '+10 XP за урок!', courses_progress: 'Пройдено {done} из {total} уроков', courses_lessons_count: '{total} уроков',
        courses_table_head_target: 'На изучаемом языке', courses_table_head_uk: 'Украинский',
