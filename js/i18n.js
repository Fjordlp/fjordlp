...
const UI_STRINGS = {
 ...
 nav_tests: 'Тести', nav_grammar: 'Граматика', nav_books: ' Книги', nav_story: ' Пригода', nav_troll: 'Тролль',
 ...
 pronounce_wrong: '🔴 Спробуй ще раз', pronounce_no_speech: ' Нічого не почув(ла) — спробуй ще', pronounce_error: ' Мікрофон недоступний',
 ...
 gen_words_error_toast: ' Не вдалося згенерувати слова. Спробуй ще раз.',
 ...
 nav_tests: 'Tests', nav_grammar: 'Grammar', nav_books: ' Books', nav_story: ' Adventure', nav_troll: 'Troll',
 ...
 pronounce_wrong: '🔴 Try again', pronounce_no_speech: " Didn't catch that — try again", pronounce_error: ' Microphone unavailable',
 ...
 gen_words_error_toast: ' Failed to generate words. Please try again.',
 ...
 norsk_gen_task_btn: ' Generate a new task (AI)', norsk_gen_task_loading: ' Generating…', norsk_task_added_toast: '✅ New task added!', norsk_gen_error_toast: ' Failed to generate the task. Please try again.', norsk_no_tasks_title: 'No tasks for this level', norsk_no_tasks_desc: 'Tap "Generate a new task" above — AI will create one for this language and level.',
 btn_listen: 'Listen',
 task_default_title: 'Task', pct_correct: '{pct}% correct ({count}/{total})', write_answer_placeholder: 'Write your answer here...', save_answer_btn: ' Save answer', check_ai_btn: ' Check with AI', check_ai_loading: ' Troll is checking…', check_ai_wait: 'Please wait, the troll is reading your text and preparing advice…', troll_sensor_advice: ' Troll examiner\'s feedback', answer_saved_toast: '✅ Answer saved! +10 XP', write_before_save_toast: ' Please write something before saving.', write_before_check_toast: ' Write something before checking.', ai_check_error: ' Failed to get AI feedback. Check your connection and try again.', start_recording_btn: ' Start recording (simulated)', recording_started_toast: ' Recording started... (simulated)', recording_done_toast: '✅ Recording done! You can keep practicing.',
 ...
 nav_tests: 'Тесты', nav_grammar: 'Грамматика', nav_books: ' Книги', nav_story: ' Приключение', nav_troll: 'Тролль',
 ...
 pronounce_wrong: '🔴 Попробуй ещё раз', pronounce_no_speech: ' Ничего не услышал(а) — попробуй ещё', pronounce_error: ' Микрофон недоступен',
 ...
 gen_words_error_toast: ' Не удалось сгенерировать слова. Попробуй ещё раз.',
