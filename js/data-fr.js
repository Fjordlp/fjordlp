...
(function () {
    ...
    const VOCAB = {
        ...
        A1: [
            ...
            { t: "Тіло", no: "l'oreille", uk: "вухо", en: "ear", ru: "ухо", ex_no: "J'ai une infection à l'oreille.", ex_uk: "У мене інфекція вуха.", en_ex: "I have an ear infection.", ru_ex: "У меня инфекция уха." },
            { t: "Тіло", no: "le nez", uk: "ніс", en: "nose", ru: "нос", ex_no: "Son nez est rouge.", ex_uk: "Її ніс червоний.", en_ex: "Her nose is red.", ru_ex: "У неё красный нос." },
            // Home
            ...
            { t: "Дім", no: "la table", uk: "стіл", en: "table", ru: "стол", ex_no: "Le livre est sur la table.", ex_uk: "Книга на столі.", en_ex: "The book is on the table.", ru_ex: "Книга на столе." },
            { t: "Дім", no: "la chaise", uk: "стілець", en: "chair", ru: "стул", ex_no: "Assieds-toi sur la chaise.", ex_uk: "Сідай на стілець.", en_ex: "Sit on the chair.", ru_ex: "Садись на стул." },
            // Transport
            { t: "Транспорт", no: "la voiture", uk: "машина", en: "car", ru: "машина", ex_no: "Nous allons au travail en voiture.", ex_uk: "Ми їздимо на роботу машиною.", en_ex: "We drive to work by car.", ru_ex: "Мы ездим на работу на машине." },
        ...
        A2: [
            ...
            { t: "Покупки", no: "acheter", uk: "купувати", en: "buy", ru: "покупать", ex_no: "J'achète du pain frais tous les jours.", ex_uk: "Я купую свіжий хліб щодня.", en_ex: "I buy fresh bread every day.", ru_ex: "Я покупаю свежий хлеб каждый день." },
            { t: "Покупки", no: "le prix", uk: "ціна", en: "price", ru: "цена", ex_no: "Quel est le prix de ceci?", ex_uk: "Яка ціна на це?", en_ex: "What is the price of this?", ru_ex: "Какая цена на это?" },
            { t: "Покупки", no: "l'argent", uk: "гроші", en: "money", ru: "деньги", ex_no: "Je n'ai pas assez d'argent.", ex_uk: "У мене недостатньо грошей.", en_ex: "I don't have enough money.", ru_ex: "У меня недостаточно денег." },
            // Directions
            { t: "Напрямки", no: "à gauche", uk: "ліворуч", en: "left", ru: "налево", ex_no: "Tourne à gauche au coin.", ex_uk: "Поверни ліворуч на розі.", en_ex: "Turn left at the corner.", ru_ex: "Поверни налево на углу." },
            { t: "Напрямки", no: "à droite", uk: "праворуч", en: "right", ru: "направо", ex_no: "La gare est à votre droite.", ex_uk: "Вокзал праворуч від вас.", en_ex: "The station is on your right.", ru_ex: "Вокзал справа от вас." },
            { t: "Напрямки", no: "tout droit", uk: "прямо", en: "straight", ru: "прямо", ex_no: "Allez tout droit.", ex_uk: "Ідіть прямо.", en_ex: "Go straight ahead.", ru_ex: "Идите прямо." },
            { t: "Напрямки", no: "la carte", uk: "карта", en: "map", ru: "карта", ex_no: "Peux-tu me montrer sur la carte?", ex_uk: "Можеш показати мені на карті?", en_ex: "Can you show me on the map?", ru_ex: "Можешь показать мне на карте?" },
            // Work
            { t: "Робота", no: "le travail", uk: "робота", en: "job", ru: "работа", ex_no: "Elle a trouvé un nouveau travail.", ex_uk: "Вона знайшла нову роботу.", en_ex: "She found a new job.", ru_ex: "Она нашла новую работу." },
            { t: "Робота", no: "le bureau", uk: "офіс", en: "office", ru: "офис", ex_no: "Je travaille dans un bureau.", ex_uk: "Я працюю в офісі.", en_ex: "I work in an office.", ru_ex: "Я работаю в офисе." },
            { t: "Робота", no: "la réunion", uk: "зустріч", en: "meeting", ru: "встреча", ex_no: "Nous avons une réunion à dix heures.", ex_uk: "У нас зустріч о десятій.", en_ex: "We have a meeting at ten.", ru_ex: "У нас встреча в десять." },
            { t: "Робота", no: "le salaire", uk: "зарплата", en: "salary", ru: "зарплата", ex_no: "Mon salaire est bon.", ex_uk: "Моя зарплата хороша.", en_ex: "My salary is good.", ru_ex: "Моя зарплата хорошая." },
            // Hobbies
            { t: "Хобі", no: "le hobby", uk: "хобі", en: "hobby", ru: "хобби", ex_no: "Quel est ton hobby?", ex_uk: "Яке твоє хобі?", en_ex: "What is your hobby?", ru_ex: "Какое у тебя хобби?" },
            { t: "Хобі", no: "lire", uk: "читати", en: "read", ru: "читать", ex_no: "J'aime lire des livres.", ex_uk: "Я люблю читати книги.", en_ex: "I like to read books.", ru_ex: "Я люблю читать книги." },
            { t: "Хобі", no: "voyager", uk: "подорожувати", en: "travel", ru: "путешествовать", ex_no: "Nous aimons voyager.", ex_uk: "Ми любимо подорожувати.", en_ex: "We love to travel.", ru_ex: "Мы любим путешествовать." },
            { t: "Хобі", no: "la musique", uk: "музика", en: "music", ru: "музыка", ex_no: "J'écoute de la musique tous les jours.", ex_uk: "Я слухаю музику щодня.", en_ex: "I listen to music every day.", ru_ex: "Я слушаю музыку каждый день." },
            // Weather
            { t: "Погода", no: "la pluie", uk: "дощ", en: "rain", ru: "дождь", ex_no: "Il va pleuvoir demain.", ex_uk: "Завтра буде дощ.", en_ex: "It's going to rain tomorrow.", ru_ex: "Завтра будет дождь." },
            { t: "Погода", no: "la neige", uk: "сніг", en: "snow", ru: "снег", ex_no: "Il neige en hiver.", ex_uk: "Взимку йде сніг.", en_ex: "It snows in winter.", ru_ex: "Зимой идёт снег." },
            { t: "Погода", no: "ensoleillé", uk: "сонячно", en: "sunny", ru: "солнечно", ex_no: "Il fait ensoleillé aujourd'hui.", ex_uk: "Сьогодні сонячно.", en_ex: "It's sunny today.", ru_ex: "Сегодня солнечно." },
            { t: "Погода", no: "froid", uk: "холодно", en: "cold", ru: "холодно", ex_no: "Il fait froid dehors.", ex_uk: "На вулиці холодно.", en_ex: "It's cold outside.", ru_ex: "На улице холодно." },
            { t: "Погода", no: "chaud", uk: "спекотно", en: "hot", ru: "жарко", ex_no: "Il fait très chaud en été.", ex_uk: "Влітку дуже спекотно.", en_ex: "It's very hot in summer.", ru_ex: "Летом очень жарко." },
            // Education
            { t: "Освіта", no: "l'école", uk: "школа", en: "school", ru: "школа", ex_no: "Les enfants vont à l'école.", ex_uk: "Діти ходять до школи.", en_ex: "The children go to school.", ru_ex: "Дети ходят в школу." },
            { t: "Освіта", no: "le professeur", uk: "вчитель", en: "teacher", ru: "учитель", ex_no: "Le professeur explique la grammaire.", ex_uk: "Вчитель пояснює граматику.", en_ex: "The teacher explains grammar.", ru_ex: "Учитель объясняет грамматику." },
            { t: "Освіта", no: "l'étudiant", uk: "студент", en: "student", ru: "студент", ex_no: "Elle est étudiante à l'université.", ex_uk: "Вона студентка університету.", en_ex: "She is a student at university.", ru_ex: "Она студентка университета." },
            { t: "Освіта", no: "l'examen", uk: "іспит", en: "exam", ru: "экзамен", ex_no: "J'ai réussi l'examen.", ex_uk: "Я склав іспит.", en_ex: "I passed the exam.", ru_ex: "Я сдал экзамен." },
            // Restaurant
            { t: "Ресторан", no: "le menu", uk: "меню", en: "menu", ru: "меню", ex_no: "Puis-je avoir le menu?", ex_uk: "Можна меню?", en_ex: "Can I have the menu?", ru_ex: "Можно меню?" },
            { t: "Ресторан", no: "l'addition", uk: "рахунок", en: "bill", ru: "счёт", ex_no: "Pouvons-nous avoir l'addition?", ex_uk: "Можна нам рахунок?", en_ex: "Can we have the bill?", ru_ex: "Можно нам счёт?" },
            { t: "Ресторан", no: "le serveur", uk: "офіціант", en: "waiter", ru: "официант", ex_no: "Le serveur est sympathique.", ex_uk: "Офіціант привітний.", en_ex: "The waiter is friendly.", ru_ex: "Официант приветливый." },
            { t: "Ресторан", no: "commander", uk: "замовляти", en: "order", ru: "заказывать", ex_no: "Nous commandons une pizza le vendredi.", ex_uk: "Ми замовляємо піцу в п'ятницю.", en_ex: "We order pizza on Friday.", ru_ex: "Мы заказываем пиццу в пятницу." },
            // Emotions
            { t: "Емоції", no: "heureux", uk: "щасливий", en: "happy", ru: "счастливый", ex_no: "Elle se sent heureuse aujourd'hui.", ex_uk: "Вона сьогодні щаслива.", en_ex: "She feels happy today.", ru_ex: "Она сегодня счастлива." },
            { t: "Емоції", no: "triste", uk: "сумний", en: "sad", ru: "грустный", ex_no: "Le film triste m'a fait pleurer.", ex_uk: "Сумний фільм змусив мене плакати.", en_ex: "The sad movie made me cry.", ru_ex: "Грустный фильм заставил меня плакать." },
            { t: "Емоції", no: "fâché", uk: "злий", en: "angry", ru: "злой", ex_no: "Il se fâche quand il est en retard.", ex_uk: "Він злиться, коли запізнюється.", en_ex: "He gets angry when he is late.", ru_ex: "Он злится, когда опаздывает." },
            { t: "Емоції", no: "fatigué", uk: "втомлений", en: "tired", ru: "уставший", ex_no: "Je me sens fatigué après le travail.", ex_uk: "Я почуваюся втомленим після роботи.", en_ex: "I feel tired after work.", ru_ex: "Я чувствую себя уставшим после работы." },
            // Past tense
            { t: "Минулий час", no: "j'ai marché", uk: "я пішов", en: "I walked", ru: "я пошёл", ex_no: "J'ai marché jusqu'à la gare.", ex_uk: "Я пішов на вокзал пішки.", en_ex: "I walked to the station.", ru_ex: "Я пошёл на вокзал пешком." },
            { t: "Минулий час", no: "j'ai visité", uk: "я відвідав", en: "I visited", ru: "я посетил", ex_no: "Nous avons visité Paris l'année dernière.", ex_uk: "Ми відвідали Париж минулого року.", en_ex: "We visited Paris last year.", ru_ex: "Мы посетили Париж в прошлом году." },
            { t: "Минулий час", no: "je suis resté", uk: "я зупинився", en: "I stayed", ru: "я остановился", ex_no: "Nous sommes restés dans un bon hôtel.", ex_uk: "Ми зупинилися в хорошому готелі.", en_ex: "We stayed at a nice hotel.", ru_ex: "Мы остановились в хорошем отеле." },
            { t: "Минулий час", no: "j'ai regardé", uk: "я дивився", en: "I watched", ru: "я смотрел", ex_no: "J'ai regardé la télévision hier soir.", ex_uk: "Я дивився телевізор учора ввечері.", en_ex: "I watched TV last night.", ru_ex: "Я смотрел телевизор вчера вечером." },
            // Health
        ...
        B1: [
            ...
            { t: "Подорожі", no: "le billet", uk: "квиток", en: "ticket", ru: "билет", ex_no: "J'ai réservé un billet en ligne.", ex_uk: "Я забронював квиток онлайн.", en_ex: "I booked a ticket online.", ru_ex: "Я забронировал билет онлайн." },
            { t: "Подорожі", no: "l'hôtel", uk: "готель", en: "hotel", ru: "отель", ex_no: "L'hôtel est près du centre.", ex_uk: "Готель біля центру.", en_ex: "The hotel is near the center.", ru_ex: "Отель рядом с центром." },
            { t: "Подорожі", no: "le passeport", uk: "паспорт", en: "passport", ru: "паспорт", ex_no: "N'oublie pas ton passeport.", ex_uk: "Не забудь паспорт.", en_ex: "Don't forget your passport.", ru_ex: "Не забудь паспорт." },
            { t: "Подорожі", no: "les bagages", uk: "багаж", en: "luggage", ru: "багаж", ex_no: "Mes bagages sont lourds.", ex_uk: "Мій багаж важкий.", en_ex: "My luggage is heavy.", ru_ex: "Мой багаж тяжёлый." },
            { t: "Подорожі", no: "le retard", uk: "затримка", en: "delay", ru: "задержка", ex_no: "Il y a eu un retard à cause du mauvais temps.", ex_uk: "Через негоду сталася затримка.", en_ex: "There was a delay due to bad weather.", ru_ex: "Из-за непогоды произошла задержка." },
            { t: "Подорожі", no: "la destination", uk: "пункт призначення", en: "destination", ru: "назначение", ex_no: "Notre destination est Paris.", ex_uk: "Наш пункт призначення — Париж.", en_ex: "Our destination is Paris.", ru_ex: "Наш пункт назначения — Париж." },
            { t: "Подорожі", no: "le touriste", uk: "турист", en: "tourist", ru: "турист", ex_no: "Les touristes visitent le musée.", ex_uk: "Туристи відвідують музей.", en_ex: "Tourists visit the museum.", ru_ex: "Туристы посещают музей." },
            // Health
            { t: "Здоров'я", no: "l'hôpital", uk: "лікарня", en: "hospital", ru: "больница", ex_no: "Il a été transporté à l'hôpital.", ex_uk: "Його відвезли до лікарні.", en_ex: "He was taken to the hospital.", ru_ex: "Его отвезли в больницу." },
            { t: "Здоров'я", no: "l'ordonnance", uk: "рецепт", en: "prescription", ru: "рецепт", ex_no: "J'ai besoin d'une ordonnance pour ce médicament.", ex_uk: "Мені потрібен рецепт на ці ліки.", en_ex: "I need a prescription for this medicine.", ru_ex: "Мне нужен рецепт на это лекарство." },
            { t: "Здоров'я", no: "l'assurance", uk: "страхування", en: "insurance", ru: "страховка", ex_no: "Il est sage d'avoir une assurance voyage.", ex_uk: "Розумно мати туристичну страховку.", en_ex: "It's wise to have travel insurance.", ru_ex: "Разумно иметь туристическую страховку." },
            { t: "Здоров'я", no: "le vaccin", uk: "вакцина", en: "vaccine", ru: "вакцина", ex_no: "Les enfants reçoivent ce vaccin gratuitement.", ex_uk: "Діти отримують цю вакцину безкоштовно.", en_ex: "Children get this vaccine for free.", ru_ex: "Дети получают эту вакцину бесплатно." },
            // Relationships
            { t: "Стосунки", no: "le partenaire", uk: "партнер", en: "partner", ru: "партнёр", ex_no: "J'ai présenté mon partenaire à ma famille.", ex_uk: "Я познайомив свого партнера з родиною.", en_ex: "I introduced my partner to my family.", ru_ex: "Я познакомил своего партнёра с семьёй." },
            { t: "Стосунки", no: "le mariage", uk: "шлюб", en: "marriage", ru: "брак", ex_no: "Ils ont célébré dix ans de mariage.", ex_uk: "Вони відсвяткували десять років шлюбу.", en_ex: "They celebrated ten years of marriage.", ru_ex: "Они отпраздновали десять лет брака." },
            { t: "Стосунки", no: "la confiance", uk: "довіра", en: "trust", ru: "доверие", ex_no: "La confiance est importante dans une relation.", ex_uk: "Довіра важлива у стосунках.", en_ex: "Trust is important in a relationship.", ru_ex: "Доверие важно в отношениях." },
            // Media
            { t: "Медіа", no: "les nouvelles", uk: "новини", en: "news", ru: "новости", ex_no: "Je regarde les nouvelles tous les soirs.", ex_uk: "Я дивлюся новини щовечора.", en_ex: "I watch the news every evening.", ru_ex: "Я смотрю новости каждый вечер." },
            { t: "Медіа", no: "le journal", uk: "газета", en: "newspaper", ru: "газета", ex_no: "Il lit le journal le matin.", ex_uk: "Він читає газету вранці.", en_ex: "He reads the newspaper in the morning.", ru_ex: "Он читает газету утром." },
            { t: "Медіа", no: "les réseaux sociaux", uk: "соціальні мережі", en: "social media", ru: "социальные сети", ex_no: "Les jeunes passent du temps sur les réseaux sociaux.", ex_uk: "Молодь проводить час у соціальних мережах.", en_ex: "Young people spend time on social media.", ru_ex: "Молодёжь проводит время в социальных сетях." },
            { t: "Медіа", no: "le podcast", uk: "подкаст", en: "podcast", ru: "подкаст", ex_no: "J'écoute des podcasts en faisant du sport.", ex_uk: "Я слухаю подкасти під час тренування.", en_ex: "I listen to podcasts while exercising.", ru_ex: "Я слушаю подкасты во время тренировки." },
            // Environment
            { t: "Довкілля", no: "l'environnement", uk: "довкілля", en: "environment", ru: "окружающая среда", ex_no: "Nous devons protéger l'environnement.", ex_uk: "Ми повинні захищати довкілля.", en_ex: "We must protect the environment.", ru_ex: "Мы должны защищать окружающую среду." },
            { t: "Довкілля", no: "le climat", uk: "клімат", en: "climate", ru: "климат", ex_no: "Le changement climatique est un problème mondial.", ex_uk: "Зміна клімату — глобальна проблема.", en_ex: "Climate change is a global problem.", ru_ex: "Изменение климата — глобальная проблема." },
            { t: "Довкілля", no: "la pollution", uk: "забруднення", en: "pollution", ru: "загрязнение", ex_no: "La pollution nuit à la faune.", ex_uk: "Забруднення шкодить дикій природі.", en_ex: "Pollution harms wildlife.", ru_ex: "Загрязнение вредит дикой природе." },
            { t: "Довкілля", no: "le recyclage", uk: "переробка", en: "recycling", ru: "переработка", ex_no: "Le recyclage est important.", ex_uk: "Переробка важлива.", en_ex: "Recycling is important.", ru_ex: "Переработка важна." },
            { t: "Довкілля", no: "les déchets", uk: "відходи", en: "waste", ru: "отходы", ex_no: "Nous trions les déchets par catégories.", ex_uk: "Ми сортуємо сміття за категоріями.", en_ex: "We sort waste into categories.", ru_ex: "Мы сортируем отходы по категориям." },
            // Verbs
            { t: "Дієслова", no: "comprendre", uk: "розуміти", en: "understand", ru: "понимать", ex_no: "Je ne comprends pas ce que tu veux dire.", ex_uk: "Я не розумію, що ти маєш на увазі.", en_ex: "I don't understand what you mean.", ru_ex: "Я не понимаю, что ты имеешь в виду." },
            { t: "Дієслова", no: "expliquer", uk: "пояснювати", en: "explain", ru: "объяснять", ex_no: "Peux-tu expliquer la règle encore une fois?", ex_uk: "Можеш пояснити правило ще раз?", en_ex: "Can you explain the rule again?", ru_ex: "Можешь объяснить правило ещё раз?" },
            { t: "Дієслова", no: "croire", uk: "вірити", en: "believe", ru: "верить", ex_no: "Je crois qu'elle a raison.", ex_uk: "Я вірю, що вона має рацію.", en_ex: "I believe she is right.", ru_ex: "Я верю, что она права." },
            { t: "Дієслова", no: "essayer", uk: "пробувати", en: "try", ru: "пытаться", ex_no: "J'essaie d'apprendre le français.", ex_uk: "Я намагаюся вивчити французьку.", en_ex: "I'm trying to learn French.", ru_ex: "Я пытаюсь выучить французский." },
            { t: "Дієслова", no: "décider", uk: "вирішувати", en: "decide", ru: "решать", ex_no: "J'ai décidé de déménager à Paris.", ex_uk: "Я вирішив переїхати до Парижа.", en_ex: "I decided to move to Paris.", ru_ex: "Я решил переехать в Париж." },
            { t: "Дієслова", no: "éviter", uk: "уникати", en: "avoid", ru: "избегать", ex_no: "Nous devons éviter les risques.", ex_uk: "Нам слід уникати ризиків.", en_ex: "We should avoid risks.", ru_ex: "Нам следует избегать рисков." },
            // Career
            { t: "Кар'єра", no: "la carrière", uk: "кар'єра", en: "career", ru: "карьера", ex_no: "Elle a une carrière réussie.", ex_uk: "Вона має успішну кар'єру.", en_ex: "She has a successful career.", ru_ex: "У неё успешная карьера." },
        ...
        B2: [
            ...
            { t: "Політика", no: "les élections", uk: "вибори", en: "election", ru: "выборы", ex_no: "Les élections ont lieu le mois prochain.", ex_uk: "Вибори відбудуться наступного місяця.", en_ex: "The election is next month.", ru_ex: "Выборы состоятся в следующем месяце." },
            { t: "Політика", no: "la démocratie", uk: "демократія", en: "democracy", ru: "демократия", ex_no: "La liberté d'expression est un pilier de la démocratie.", ex_uk: "Свобода слова — основа демократії.", en_ex: "Freedom of speech is a cornerstone of democracy.", ru_ex: "Свобода слова — основа демократии." },
            { t: "Політика", no: "l'opposition", uk: "опозиція", en: "opposition", ru: "оппозиция", ex_no: "L'opposition a critiqué la proposition.", ex_uk: "Опозиція розкритикувала пропозицію.", en_ex: "The opposition criticized the proposal.", ru_ex: "Оппозиция раскритиковала предложение." },
            // Economy
            { t: "Економіка", no: "l'économie", uk: "економіка", en: "economy", ru: "экономика", ex_no: "L'économie croît lentement.", ex_uk: "Економіка зростає повільно.", en_ex: "The economy is growing slowly.", ru_ex: "Экономика растёт медленно." },
            { t: "Економіка", no: "le marché", uk: "ринок", en: "market", ru: "рынок", ex_no: "Le marché a réagi à la nouvelle.", ex_uk: "Ринок відреагував на новину.", en_ex: "The market reacted to the news.", ru_ex: "Рынок отреагировал на новость." },
            { t: "Економіка", no: "l'inflation", uk: "інфляція", en: "inflation", ru: "инфляция", ex_no: "L'inflation a fortement augmenté.", ex_uk: "Інфляція різко зросла.", en_ex: "Inflation has risen sharply.", ru_ex: "Инфляция резко выросла." },
            { t: "Економіка", no: "l'investissement", uk: "інвестиція", en: "investment", ru: "инвестиция", ex_no: "L'investissement à long terme est important.", ex_uk: "Довгострокові інвестиції важливі.", en_ex: "Long-term investment is important.", ru_ex: "Долгосрочные инвестиции важны." },
            // Science
            { t: "Наука", no: "la recherche", uk: "дослідження", en: "research", ru: "исследование", ex_no: "De nouvelles recherches montrent des résultats surprenants.", ex_uk: "Нове дослідження показує несподівані результати.", en_ex: "New research shows surprising results.", ru_ex: "Новое исследование показывает неожиданные результаты." },
            { t: "Наука", no: "la théorie", uk: "теорія", en: "theory", ru: "теория", ex_no: "La théorie a été confirmée par des expériences.", ex_uk: "Теорію підтвердили експерименти.", en_ex: "The theory was confirmed by experiments.", ru_ex: "Теорию подтвердили эксперименты." },
            { t: "Наука", no: "l'expérience", uk: "експеримент", en: "experiment", ru: "эксперимент", ex_no: "Ils ont mené une expérience contrôlée.", ex_uk: "Вони провели контрольований експеримент.", en_ex: "They conducted a controlled experiment.", ru_ex: "Они провели контролируемый эксперимент." },
            { t: "Наука", no: "les données", uk: "дані", en: "data", ru: "данные", ex_no: "Les données ont été collectées sur plusieurs mois.", ex_uk: "Дані збирали протягом кількох місяців.", en_ex: "Data was collected over several months.", ru_ex: "Данные собирали в течение нескольких месяцев." },
            // Culture
            { t: "Культура", no: "l'art", uk: "мистецтво", en: "art", ru: "искусство", ex_no: "L'exposition montre l'art moderne.", ex_uk: "Виставка демонструє сучасне мистецтво.", en_ex: "The exhibition shows modern art.", ru_ex: "Выставка демонстрирует современное искусство." },
            { t: "Культура", no: "la littérature", uk: "література", en: "literature", ru: "литература", ex_no: "Elle étudie la littérature française.", ex_uk: "Вона вивчає французьку літературу.", en_ex: "She studies French literature.", ru_ex: "Она изучает французскую литературу." },
            { t: "Культура", no: "l'auteur", uk: "автор", en: "author", ru: "автор", ex_no: "L'auteur a reçu une reconnaissance.", ex_uk: "Автор отримав визнання.", en_ex: "The author received recognition.", ru_ex: "Автор получил признание." },
            // Verbs
            { t: "Дієслова", no: "influencer", uk: "впливати", en: "influence", ru: "влиять", ex_no: "Les médias influencent l'opinion publique.", ex_uk: "ЗМІ впливають на громадську думку.", en_ex: "The media influences public opinion.", ru_ex: "СМИ влияют на общественное мнение." },
            { t: "Дієслова", no: "évaluer", uk: "оцінювати", en: "assess", ru: "оценивать", ex_no: "Nous devons évaluer la situation.", ex_uk: "Нам потрібно оцінити ситуацію.", en_ex: "We need to assess the situation.", ru_ex: "Нам нужно оценить ситуацию." },
            { t: "Дієслова", no: "développer", uk: "розвивати", en: "develop", ru: "развивать", ex_no: "L'entreprise développe de nouveaux produits.", ex_uk: "Компанія розробляє нові продукти.", en_ex: "The company is developing new products.", ru_ex: "Компания разрабатывает новые продукты." },
            { t: "Дієслова", no: "présenter", uk: "представляти", en: "present", ru: "представлять", ex_no: "Elle a présenté les résultats au conseil.", ex_uk: "Вона представила результати правлінню.", en_ex: "She presented the results to the board.", ru_ex: "Она представила результаты правлению." },
            { t: "Дієслова", no: "analyser", uk: "аналізувати", en: "analyze", ru: "анализировать", ex_no: "Nous devons analyser les données.", ex_uk: "Нам потрібно проаналізувати дані.", en_ex: "We need to analyze the data.", ru_ex: "Нам нужно проанализировать данные." },
            // Business
            { t: "Бізнес", no: "l'entreprise", uk: "підприємство", en: "business", ru: "бизнес", ex_no: "L'entreprise va bien cette année.", ex_uk: "Цього року бізнес іде добре.", en_ex: "Business is going well this year.", ru_ex: "В этом году бизнес идёт хорошо." },
            { t: "Бізнес", no: "la stratégie", uk: "стратегія", en: "strategy", ru: "стратегия", ex_no: "Nous avons besoin d'une nouvelle stratégie.", ex_uk: "Нам потрібна нова стратегія.", en_ex: "We need a new strategy.", ru_ex: "Нам нужна новая стратегия." },
            { t: "Бізнес", no: "la concurrence", uk: "конкуренція", en: "competition", ru: "конкуренция", ex_no: "La concurrence est rude.", ex_uk: "Конкуренція є жорсткою.", en_ex: "Competition is intense.", ru_ex: "Конкуренция жёсткая." },
            // Medicine
            { t: "Медицина", no: "le symptôme", uk: "симптом", en: "symptom", ru: "симптом", ex_no: "La fièvre est un symptôme courant.", ex_uk: "Температура — поширений симптом.", en_ex: "Fever is a common symptom.", ru_ex: "Температура — распространённый симптом." },
        ...
        C1: [
            ...
            { t: "Дискурс", no: "de plus", uk: "крім того", en: "moreover", ru: "кроме того", ex_no: "Le projet est cher et, de plus, il prend beaucoup de temps.", ex_uk: "Проєкт дорогий, і до того ж забирає багато часу.", en_ex: "The project is expensive, and moreover time-consuming.", ru_ex: "Проект дорогой, и к тому же отнимает много времени." },
            { t: "Дискурс", no: "par conséquent", uk: "отже", en: "consequently", ru: "следовательно", ex_no: "La demande a chuté et, par conséquent, les prix ont baissé.", ex_uk: "Попит впав, і ціни, відповідно, знизилися.", en_ex: "Demand fell, and prices consequently dropped.", ru_ex: "Спрос упал, и цены, соответственно, снизились." },
            { t: "Дискурс", no: "malgré", uk: "незважаючи на", en: "despite", ru: "несмотря на", ex_no: "Malgré les difficultés, ils ont terminé le projet.", ex_uk: "Незважаючи на труднощі, вони завершили проєкт.", en_ex: "Despite the challenges, they completed the project.", ru_ex: "Несмотря на трудности, они завершили проект." },
            { t: "Дискурс", no: "en d'autres termes", uk: "іншими словами", en: "in other words", ru: "другими словами", ex_no: "En d'autres termes, la situation est plus compliquée.", ex_uk: "Іншими словами, ситуація складніша.", en_ex: "In other words, the situation is more complicated.", ru_ex: "Другими словами, ситуация сложнее." },
            // Nuance
            { t: "Нюанси", no: "insinuer", uk: "натякати", en: "imply", ru: "намекать", ex_no: "Le rapport insinue que plusieurs facteurs sont en jeu.", ex_uk: "Звіт натякає, що діють кілька факторів.", en_ex: "The report implies that several factors are at play.", ru_ex: "Отчёт намекает, что действуют несколько факторов." },
            { t: "Нюанси", no: "souligner", uk: "підкреслювати", en: "emphasize", ru: "подчёркивать", ex_no: "L'orateur a souligné l'importance de la coopération.", ex_uk: "Доповідач підкреслив важливість співпраці.", en_ex: "The speaker emphasized the importance of cooperation.", ru_ex: "Докладчик подчеркнул важность сотрудничества." },
            { t: "Нюанси", no: "étayer", uk: "обґрунтовувати", en: "substantiate", ru: "обосновывать", ex_no: "Tu dois étayer ton affirmation par des preuves.", ex_uk: "Тобі потрібно обґрунтувати своє твердження доказами.", en_ex: "You need to substantiate your claim with evidence.", ru_ex: "Тебе нужно обосновать своё утверждение доказательствами." },
            { t: "Нюанси", no: "nuancé", uk: "нюансований", en: "nuanced", ru: "нюансированный", ex_no: "Le débat nécessite une approche plus nuancée.", ex_uk: "Дебати потребують більш нюансованого підходу.", en_ex: "The debate requires a more nuanced approach.", ru_ex: "Дебаты требуют более нюансированного подхода." },
            { t: "Нюанси", no: "exhaustif", uk: "всеохопний", en: "comprehensive", ru: "всеобъемлющий", ex_no: "Il s'agit d'une étude exhaustive.", ex_uk: "Це всеохопне дослідження.", en_ex: "This is a comprehensive study.", ru_ex: "Это всеобъемлющее исследование." },
            // Academic
            { t: "Академічна", no: "l'hypothèse", uk: "гіпотеза", en: "hypothesis", ru: "гипотеза", ex_no: "Les chercheurs ont testé l'hypothèse.", ex_uk: "Науковці перевірили гіпотезу.", en_ex: "The researchers tested the hypothesis.", ru_ex: "Учёные проверили гипотезу." },
            { t: "Академічна", no: "la méthodologie", uk: "методологія", en: "methodology", ru: "методология", ex_no: "La méthodologie est clairement décrite.", ex_uk: "Методологія чітко описана.", en_ex: "The methodology is clearly described.", ru_ex: "Методология четко описана." },
            { t: "Академічна", no: "la perspective", uk: "перспектива", en: "perspective", ru: "перспектива", ex_no: "D'un point de vue historique, l'événement était significatif.", ex_uk: "З історичної перспективи подія була значущою.", en_ex: "From a historical perspective, the event was significant.", ru_ex: "С исторической точки зрения событие было значимым." },
            { t: "Академічна", no: "la critique des sources", uk: "критика джерел", en: "source criticism", ru: "критика источников", ex_no: "Une bonne critique des sources est cruciale.", ex_uk: "Гарна критика джерел є вирішальною.", en_ex: "Good source criticism is crucial.", ru_ex: "Хорошая критика источников имеет решающее значение." },
            // Philosophy
            { t: "Філософія", no: "l'existence", uk: "існування", en: "existence", ru: "существование", ex_no: "La question de l'existence est éternelle.", ex_uk: "Питання про існування вічне.", en_ex: "The question of existence is eternal.", ru_ex: "Вопрос о существовании вечен." },
            { t: "Філософія", no: "la conscience", uk: "свідомість", en: "consciousness", ru: "сознание", ex_no: "La conscience est un phénomène complexe.", ex_uk: "Свідомість — складне явище.", en_ex: "Consciousness is a complex phenomenon.", ru_ex: "Сознание — сложное явление." },
            { t: "Філософія", no: "l'éthique", uk: "етика", en: "ethics", ru: "этика", ex_no: "L'éthique traite de ce qui est bien et mal.", ex_uk: "Етика стосується того, що правильно, а що ні.", en_ex: "Ethics deals with what is right and wrong.", ru_ex: "Этика касается того, что правильно, а что нет." },
            // Linguistics
            { t: "Лінгвістика", no: "la syntaxe", uk: "синтаксис", en: "syntax", ru: "синтаксис", ex_no: "La syntaxe est l'étude de la structure des phrases.", ex_uk: "Синтаксис — це вивчення структури речень.", en_ex: "Syntax is the study of sentence structure.", ru_ex: "Синтаксис — это изучение структуры предложений." },
            { t: "Лінгвістика", no: "la sémantique", uk: "семантика", en: "semantics", ru: "семантика", ex_no: "La sémantique traite du sens.", ex_uk: "Семантика займається значенням.", en_ex: "Semantics deals with meaning.", ru_ex: "Семантика занимается значением." },
            // Sociology
            { t: "Соціологія", no: "l'inégalité sociale", uk: "соціальна нерівність", en: "social inequality", ru: "социальное неравенство", ex_no: "L'inégalité sociale est un problème majeur.", ex_uk: "Соціальна нерівність — велика проблема.", en_ex: "Social inequality is a major problem.", ru_ex: "Социальное неравенство — большая проблема." },
            { t: "Соціологія", no: "l'intégration", uk: "інтеграція", en: "integration", ru: "интеграция", ex_no: "L'intégration des immigrants est importante.", ex_uk: "Інтеграція іммігрантів важлива.", en_ex: "Integration of immigrants is important.", ru_ex: "Интеграция иммигрантов важна." },
            { t: "Соціологія", no: "la diversité", uk: "різноманіття", en: "diversity", ru: "разнообразие", ex_no: "La diversité enrichit la société.", ex_uk: "Різноманіття збагачує суспільство.", en_ex: "Diversity enriches society.", ru_ex: "Разнообразие обогащает общество." },
            // Psychology
            { t: "Психологія", no: "la cognition", uk: "когніція", en: "cognition", ru: "когниция", ex_no: "La cognition comprend la pensée et la mémoire.", ex_uk: "Когніція охоплює мислення та пам'ять.", en_ex: "Cognition includes thinking and memory.", ru_ex: "Когниция охватывает мышление и память." },
        ...
        C2: [
            ...
            { t: "Стилістика", no: "l'ironie", uk: "іронія", en: "irony", ru: "ирония", ex_no: "Son commentaire était ironique.", ex_uk: "Його коментар був іронією.", en_ex: "His comment was ironic.", ru_ex: "Его комментарий был иронией." },
            // Rare vocabulary
            { t: "Рідкісна лексика", no: "éphémère", uk: "минущий", en: "transient", ru: "преходящий", ex_no: "La gloire peut être éphémère.", ex_uk: "Слава може бути минущою.", en_ex: "Fame can be transient.", ru_ex: "Слава может быть преходящей." },
            { t: "Рідкісна лексика", no: "imprévisible", uk: "непередбачуваний", en: "unpredictable", ru: "непредсказуемый", ex_no: "Le temps est imprévisible.", ex_uk: "Погода непередбачувана.", en_ex: "The weather is unpredictable.", ru_ex: "Погода непредсказуема." },
            { t: "Рідкісна лексика", no: "inévitable", uk: "неминучий", en: "inevitable", ru: "неизбежный", ex_no: "Le conflit semblait inévitable.", ex_uk: "Конфлікт здавався неминучим.", en_ex: "The conflict seemed inevitable.", ru_ex: "Конфликт казался неизбежным." },
            // Rhetoric
            { t: "Риторика", no: "la rhétorique", uk: "риторика", en: "rhetoric", ru: "риторика", ex_no: "La rhétorique est l'art de la persuasion.", ex_uk: "Риторика — це мистецтво переконання.", en_ex: "Rhetoric is the art of persuasion.", ru_ex: "Риторика — это искусство убеждения." },
            { t: "Риторика", no: "l'argumentation", uk: "аргументація", en: "argumentation", ru: "аргументация", ex_no: "Son argumentation était solide.", ex_uk: "Його аргументація була вагомою.", en_ex: "His argumentation was solid.", ru_ex: "Его аргументация была убедительной." },
            { t: "Риторика", no: "l'appel", uk: "звернення", en: "appeal", ru: "апелляция", ex_no: "L'appel aux émotions était fort.", ex_uk: "Звернення до емоцій було сильним.", en_ex: "The appeal to emotions was strong.", ru_ex: "Обращение к эмоциям было сильным." },
            // Literary
            { t: "Літературознавство", no: "le motif", uk: "мотив", en: "motif", ru: "мотив", ex_no: "L'amour est un motif central dans le livre.", ex_uk: "Кохання — центральний мотив у книзі.", en_ex: "Love is a central motif in the book.", ru_ex: "Любовь — центральный мотив в книге." },
            { t: "Літературознавство", no: "le thème", uk: "тема", en: "theme", ru: "тема", ex_no: "Le thème du roman est la solitude.", ex_uk: "Тема роману — самотність.", en_ex: "The theme of the novel is loneliness.", ru_ex: "Тема романа — одиночество." },
            { t: "Літературознавство", no: "le symbolisme", uk: "символіка", en: "symbolism", ru: "символика", ex_no: "Le poème est riche en symbolisme.", ex_uk: "Вірш багатий на символіку.", en_ex: "The poem is rich in symbolism.", ru_ex: "Стихотворение богато на символику." },
            // Abstract
            { t: "Абстрактне", no: "le contraste", uk: "контраст", en: "contrast", ru: "контраст", ex_no: "Le contraste entre riches et pauvres est grand.", ex_uk: "Контраст між багатими та бідними великий.", en_ex: "The contrast between rich and poor is stark.", ru_ex: "Контраст между богатыми и бедными велик." },
            { t: "Абстрактне", no: "exclure", uk: "виключати", en: "exclude", ru: "исключать", ex_no: "Nous ne devons exclure personne.", ex_uk: "Ми не повинні нікого виключати.", en_ex: "We must not exclude anyone.", ru_ex: "Мы не должны никого исключать." },
            { t: "Абстрактне", no: "inclure", uk: "включати", en: "include", ru: "включать", ex_no: "Tout le monde devrait être inclus.", ex_uk: "Усі повинні бути включені.", en_ex: "Everyone should be included.", ru_ex: "Все должны быть включены." },
            { t: "Абстрактне", no: "le contexte", uk: "контекст", en: "context", ru: "контекст", ex_no: "Sans contexte, c'est difficile à comprendre.", ex_uk: "Без контексту важко зрозуміти.", en_ex: "Without context, it's hard to understand.", ru_ex: "Без контекста трудно понять." },
            { t: "Абстрактне", no: "refléter", uk: "відображати", en: "reflect", ru: "отражать", ex_no: "La conversation reflète les changements sociaux.", ex_uk: "Розмова відображає соціальні зміни.", en_ex: "The conversation reflects social changes.", ru_ex: "Разговор отражает социальные изменения." },
            { t: "Абстрактне", no: "élaborer", uk: "деталізувати", en: "elaborate", ru: "детализировать", ex_no: "Peux-tu élaborer ce point?", ex_uk: "Можеш детальніше розкрити цей пункт?", en_ex: "Can you elaborate on that point?", ru_ex: "Можешь детальнее раскрыть этот пункт?" },
        ],
    };
