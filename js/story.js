...
async function generateStoryChapter(choiceMade) {
    ...
    const userMsg =
        ...
        `Напиши один короткий розділ (60-110 слів мовою ${langName}) і завершіть розвилкою: сценою, де " +
        "гравець має прийняти рішення. Дай 2-3 короткі варіанти дії мовою ${langName} (по 2-6 слів кожен).\n\n` +
        `Формат відповіді:\n` +
