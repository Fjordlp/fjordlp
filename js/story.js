...
async function generateStoryChapter(choiceMade) {
    ...
    const userMsg =
        ...
        `"newWords": [{"no":"нове слово мовою вивчення","uk":"переклад українською","en":"переклад англійською","ru":"переклад російською","ex_no":"ТОЧНЕ речення з тексту розділу вище, де вжито це слово","ex_uk":"переклад цього речення українською"}], ` +
