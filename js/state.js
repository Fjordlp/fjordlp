        ...
        function ensureStateDefaults(state) {
            ...
            // Та сама перевірка "чи це насправді існуючий користувач", що й у
            // shouldShowOnboarding()/getInitialRoute() (helpers.js/auth.js) —
            // тут вона застосовується ще РАНІШЕ, одразу при завантаженні стану,
            // щоб прапорці були виправлені в самому джерелі, а не лише в момент
            // вирішення маршруту.
