...
(function () {
    ...
    const VOCAB = {
        ...
        A1: [
            ...
            { t: "Тіло", no: "das Ohr", uk: "вухо", en: "ear", ru: "ухо", ex_no: "Ich habe eine Ohrenentzündung.", ex_uk: "У мене інфекція вуха.", en_ex: "I have an ear infection.", ru_ex: "У меня инфекция уха." },
            { t: "Тіло", no: "die Nase", uk: "ніс", en: "nose", ru: "нос", ex_no: "Ihre Nase ist rot.", ex_uk: "Її ніс червоний.", en_ex: "Her nose is red.", ru_ex: "У неё красный нос." },
            // Home
            ...
            { t: "Дім", no: "der Tisch", uk: "стіл", en: "table", ru: "стол", ex_no: "Das Buch liegt auf dem Tisch.", ex_uk: "Книга на столі.", en_ex: "The book is on the table.", ru_ex: "Книга на столе." },
            { t: "Дім", no: "der Stuhl", uk: "стілець", en: "chair", ru: "стул", ex_no: "Setz dich auf den Stuhl.", ex_uk: "Сідай на стілець.", en_ex: "Sit on the chair.", ru_ex: "Садись на стул." },
            // Transport
            { t: "Транспорт", no: "das Auto", uk: "машина", en: "car", ru: "машина", ex_no: "Wir fahren mit dem Auto zur Arbeit.", ex_uk: "Ми їздимо на роботу машиною.", en_ex: "We drive to work by car.", ru_ex: "Мы ездим на работу на машине." },
            { t: "Транспорт", no: "der Bus", uk: "автобус", en: "bus", ru: "автобус", ex_no: "Ich fahre mit dem Bus zur Schule.", ex_uk: "Я їду автобусом до школи.", en_ex: "I take the bus to school.", ru_ex: "Я еду автобусом в школу." },
            { t: "Транспорт", no: "der Zug", uk: "поїзд", en: "train", ru: "поезд", ex_no: "Der Zug fährt um acht ab.", ex_uk: "Поїзд відправляється о восьмій.", en_ex: "The train leaves at eight.", ru_ex: "Поезд отправляется в восемь." },
            { t: "Транспорт", no: "das Fahrrad", uk: "велосипед", en: "bicycle", ru: "велосипед", ex_no: "Ich fahre mit dem Fahrrad zur Arbeit.", ex_uk: "Я їду на велосипеді на роботу.", en_ex: "I ride my bicycle to work.", ru_ex: "Я еду на велосипеде на работу." },
        ],

        // -------------------- A2 --------------------
        A2: [
            // Shopping
            { t: "Покупки", no: "das Geschäft", uk: "магазин", en: "shop", ru: "магазин", ex_no: "Das Geschäft öffnet um neun.", ex_uk: "Магазин відкривається о дев'ятій.", en_ex: "The shop opens at nine.", ru_ex: "Магазин открывается в девять." },
            { t: "Покупки", no: "kaufen", uk: "купувати", en: "buy", ru: "покупать", ex_no: "Ich kaufe jeden Tag frisches Brot.", ex_uk: "Я купую свіжий хліб щодня.", en_ex: "I buy fresh bread every day.", ru_ex: "Я покупаю свежий хлеб каждый день." },
            { t: "Покупки", no: "der Preis", uk: "ціна", en: "price", ru: "цена", ex_no: "Was ist der Preis dafür?", ex_uk: "Яка ціна на це?", en_ex: "What is the price of this?", ru_ex: "Какая цена на это?" },
            { t: "Покупки", no: "das Geld", uk: "гроші", en: "money", ru: "деньги", ex_no: "Ich habe nicht genug Geld.", ex_uk: "У мене недостатньо грошей.", en_ex: "I don't have enough money.", ru_ex: "У меня недостаточно денег." },
            // Directions
            { t: "Напрямки", no: "links", uk: "ліворуч", en: "left", ru: "налево", ex_no: "Biege links an der Ecke ab.", ex_uk: "Поверни ліворуч на розі.", en_ex: "Turn left at the corner.", ru_ex: "Поверни налево на углу." },
            { t: "Напрямки", no: "rechts", uk: "праворуч", en: "right", ru: "направо", ex_no: "Der Bahnhof ist rechts von dir.", ex_uk: "Вокзал праворуч від тебе.", en_ex: "The station is on your right.", ru_ex: "Вокзал справа от тебя." },
            { t: "Напрямки", no: "geradeaus", uk: "прямо", en: "straight", ru: "прямо", ex_no: "Geh geradeaus.", ex_uk: "Іди прямо.", en_ex: "Go straight ahead.", ru_ex: "Иди прямо." },
            { t: "Напрямки", no: "die Karte", uk: "карта", en: "map", ru: "карта", ex_no: "Kannst du es mir auf der Karte zeigen?", ex_uk: "Можеш показати мені на карті?", en_ex: "Can you show me on the map?", ru_ex: "Можешь показать мне на карте?" },
            // Work
            { t: "Робота", no: "der Job", uk: "робота", en: "job", ru: "работа", ex_no: "Sie hat einen neuen Job gefunden.", ex_uk: "Вона знайшла нову роботу.", en_ex: "She found a new job.", ru_ex: "Она нашла новую работу." },
            { t: "Робота", no: "das Büro", uk: "офіс", en: "office", ru: "офис", ex_no: "Ich arbeite in einem Büro.", ex_uk: "Я працюю в офісі.", en_ex: "I work in an office.", ru_ex: "Я работаю в офисе." },
            { t: "Робота", no: "das Treffen", uk: "зустріч", en: "meeting", ru: "встреча", ex_no: "Wir haben um zehn ein Treffen.", ex_uk: "У нас зустріч о десятій.", en_ex: "We have a meeting at ten.", ru_ex: "У нас встреча в десять." },
            { t: "Робота", no: "das Gehalt", uk: "зарплата", en: "salary", ru: "зарплата", ex_no: "Mein Gehalt ist gut.", ex_uk: "Моя зарплата хороша.", en_ex: "My salary is good.", ru_ex: "Моя зарплата хорошая." },
            // Hobbies
            { t: "Хобі", no: "das Hobby", uk: "хобі", en: "hobby", ru: "хобби", ex_no: "Was ist dein Hobby?", ex_uk: "Яке твоє хобі?", en_ex: "What is your hobby?", ru_ex: "Какое у тебя хобби?" },
            { t: "Хобі", no: "lesen", uk: "читати", en: "read", ru: "читать", ex_no: "Ich lese gerne Bücher.", ex_uk: "Я люблю читати книги.", en_ex: "I like to read books.", ru_ex: "Я люблю читать книги." },
            { t: "Хобі", no: "reisen", uk: "подорожувати", en: "travel", ru: "путешествовать", ex_no: "Wir reisen gerne.", ex_uk: "Ми любимо подорожувати.", en_ex: "We love to travel.", ru_ex: "Мы любим путешествовать." },
            { t: "Хобі", no: "die Musik", uk: "музика", en: "music", ru: "музыка", ex_no: "Ich höre jeden Tag Musik.", ex_uk: "Я слухаю музику щодня.", en_ex: "I listen to music every day.", ru_ex: "Я слушаю музыку каждый день." },
            // Weather
            { t: "Погода", no: "der Regen", uk: "дощ", en: "rain", ru: "дождь", ex_no: "Morgen wird es regnen.", ex_uk: "Завтра буде дощ.", en_ex: "It's going to rain tomorrow.", ru_ex: "Завтра будет дождь." },
            { t: "Погода", no: "der Schnee", uk: "сніг", en: "snow", ru: "снег", ex_no: "Im Winter schneit es.", ex_uk: "Взимку йде сніг.", en_ex: "It snows in winter.", ru_ex: "Зимой идёт снег." },
            { t: "Погода", no: "sonnig", uk: "сонячно", en: "sunny", ru: "солнечно", ex_no: "Heute ist es sonnig.", ex_uk: "Сьогодні сонячно.", en_ex: "It's sunny today.", ru_ex: "Сегодня солнечно." },
            { t: "Погода", no: "kalt", uk: "холодно", en: "cold", ru: "холодно", ex_no: "Draußen ist es kalt.", ex_uk: "На вулиці холодно.", en_ex: "It's cold outside.", ru_ex: "На улице холодно." },
            { t: "Погода", no: "heiß", uk: "спекотно", en: "hot", ru: "жарко", ex_no: "Im Sommer ist es sehr heiß.", ex_uk: "Влітку дуже спекотно.", en_ex: "It's very hot in summer.", ru_ex: "Летом очень жарко." },
            // Education
            { t: "Освіта", no: "die Schule", uk: "школа", en: "school", ru: "школа", ex_no: "Die Kinder gehen zur Schule.", ex_uk: "Діти ходять до школи.", en_ex: "The children go to school.", ru_ex: "Дети ходят в школу." },
            { t: "Освіта", no: "der Lehrer", uk: "вчитель", en: "teacher", ru: "учитель", ex_no: "Der Lehrer erklärt die Grammatik.", ex_uk: "Вчитель пояснює граматику.", en_ex: "The teacher explains grammar.", ru_ex: "Учитель объясняет грамматику." },
            { t: "Освіта", no: "der Student", uk: "студент", en: "student", ru: "студент", ex_no: "Sie ist Studentin an der Universität.", ex_uk: "Вона студентка університету.", en_ex: "She is a student at university.", ru_ex: "Она студентка университета." },
            { t: "Освіта", no: "die Prüfung", uk: "іспит", en: "exam", ru: "экзамен", ex_no: "Ich habe die Prüfung bestanden.", ex_uk: "Я склав іспит.", en_ex: "I passed the exam.", ru_ex: "Я сдал экзамен." },
            // Restaurant
            { t: "Ресторан", no: "die Speisekarte", uk: "меню", en: "menu", ru: "меню", ex_no: "Kann ich die Speisekarte haben?", ex_uk: "Можна меню?", en_ex: "Can I have the menu?", ru_ex: "Можно меню?" },
            { t: "Ресторан", no: "die Rechnung", uk: "рахунок", en: "bill", ru: "счёт", ex_no: "Können wir die Rechnung haben?", ex_uk: "Можна нам рахунок?", en_ex: "Can we have the bill?", ru_ex: "Можно нам счёт?" },
            { t: "Ресторан", no: "der Kellner", uk: "офіціант", en: "waiter", ru: "официант", ex_no: "Der Kellner ist freundlich.", ex_uk: "Офіціант привітний.", en_ex: "The waiter is friendly.", ru_ex: "Официант приветливый." },
            { t: "Ресторан", no: "bestellen", uk: "замовляти", en: "order", ru: "заказывать", ex_no: "Wir bestellen freitags Pizza.", ex_uk: "Ми замовляємо піцу в п'ятницю.", en_ex: "We order pizza on Friday.", ru_ex: "Мы заказываем пиццу в пятницу." },
            // Emotions
            { t: "Емоції", no: "glücklich", uk: "щасливий", en: "happy", ru: "счастливый", ex_no: "Sie fühlt sich heute glücklich.", ex_uk: "Вона сьогодні щаслива.", en_ex: "She feels happy today.", ru_ex: "Она сегодня счастлива." },
            { t: "Емоції", no: "traurig", uk: "сумний", en: "sad", ru: "грустный", ex_no: "Der traurige Film hat mich zum Weinen gebracht.", ex_uk: "Сумний фільм змусив мене плакати.", en_ex: "The sad movie made me cry.", ru_ex: "Грустный фильм заставил меня плакать." },
            { t: "Емоції", no: "wütend", uk: "злий", en: "angry", ru: "злой", ex_no: "Er wird wütend, wenn er zu spät kommt.", ex_uk: "Він злиться, коли запізнюється.", en_ex: "He gets angry when he is late.", ru_ex: "Он злится, когда опаздывает." },
            { t: "Емоції", no: "müde", uk: "втомлений", en: "tired", ru: "уставший", ex_no: "Ich fühle mich nach der Arbeit müde.", ex_uk: "Я почуваюся втомленим після роботи.", en_ex: "I feel tired after work.", ru_ex: "Я чувствую себя уставшим после работы." },
            // Past tense
            { t: "Минулий час", no: "gegangen", uk: "пішов", en: "went", ru: "пошёл", ex_no: "Ich bin zur Arbeit gegangen.", ex_uk: "Я пішов на роботу.", en_ex: "I went to work.", ru_ex: "Я пошёл на работу." },
            { t: "Минулий час", no: "besucht", uk: "відвідав", en: "visited", ru: "посетил", ex_no: "Wir haben Berlin besucht.", ex_uk: "Ми відвідали Берлін.", en_ex: "We visited Berlin.", ru_ex: "Мы посетили Берлин." },
            { t: "Минулий час", no: "geblieben", uk: "зупинився", en: "stayed", ru: "остановился", ex_no: "Wir sind in einem guten Hotel geblieben.", ex_uk: "Ми зупинилися в хорошому готелі.", en_ex: "We stayed at a nice hotel.", ru_ex: "Мы остановились в хорошем отеле." },
            { t: "Минулий час", no: "gegessen", uk: "поїв", en: "ate", ru: "поел", ex_no: "Ich habe einen Apfel gegessen.", ex_uk: "Я з'їв яблуко.", en_ex: "I ate an apple.", ru_ex: "Я съел яблоко." },
        ],

        // -------------------- B1 --------------------
        B1: [
            // Travel
            { t: "Подорожі", no: "der Flughafen", uk: "аеропорт", en: "airport", ru: "аэропорт", ex_no: "Wir treffen uns am Flughafen.", ex_uk: "Зустрінемось в аеропорту.", en_ex: "We meet at the airport.", ru_ex: "Встретимся в аэропорту." },
            { t: "Подорожі", no: "das Ticket", uk: "квиток", en: "ticket", ru: "билет", ex_no: "Ich habe ein Ticket online gebucht.", ex_uk: "Я забронював квиток онлайн.", en_ex: "I booked a ticket online.", ru_ex: "Я забронировал билет онлайн." },
            { t: "Подорожі", no: "das Hotel", uk: "готель", en: "hotel", ru: "отель", ex_no: "Das Hotel ist in der Nähe des Zentrums.", ex_uk: "Готель біля центру.", en_ex: "The hotel is near the center.", ru_ex: "Отель рядом с центром." },
            { t: "Подорожі", no: "der Pass", uk: "паспорт", en: "passport", ru: "паспорт", ex_no: "Vergiss deinen Pass nicht.", ex_uk: "Не забудь паспорт.", en_ex: "Don't forget your passport.", ru_ex: "Не забудь паспорт." },
            { t: "Подорожі", no: "das Gepäck", uk: "багаж", en: "luggage", ru: "багаж", ex_no: "Mein Gepäck ist schwer.", ex_uk: "Мій багаж важкий.", en_ex: "My luggage is heavy.", ru_ex: "Мой багаж тяжёлый." },
            { t: "Подорожі", no: "die Verspätung", uk: "затримка", en: "delay", ru: "задержка", ex_no: "Es gab eine Verspätung wegen des Wetters.", ex_uk: "Через погоду сталася затримка.", en_ex: "There was a delay due to bad weather.", ru_ex: "Из-за погоды произошла задержка." },
            { t: "Подорожі", no: "das Reiseziel", uk: "пункт призначення", en: "destination", ru: "назначение", ex_no: "Unser Reiseziel ist Berlin.", ex_uk: "Наш пункт призначення — Берлін.", en_ex: "Our destination is Berlin.", ru_ex: "Наш пункт назначения — Берлин." },
            { t: "Подорожі", no: "der Tourist", uk: "турист", en: "tourist", ru: "турист", ex_no: "Die Touristen besuchen das Museum.", ex_uk: "Туристи відвідують музей.", en_ex: "Tourists visit the museum.", ru_ex: "Туристы посещают музей." },
            // Health
            { t: "Здоров'я", no: "das Krankenhaus", uk: "лікарня", en: "hospital", ru: "больница", ex_no: "Er wurde ins Krankenhaus gebracht.", ex_uk: "Його відвезли до лікарні.", en_ex: "He was taken to the hospital.", ru_ex: "Его отвезли в больницу." },
            { t: "Здоров'я", no: "das Rezept", uk: "рецепт", en: "prescription", ru: "рецепт", ex_no: "Ich brauche ein Rezept für dieses Medikament.", ex_uk: "Мені потрібен рецепт на ці ліки.", en_ex: "I need a prescription for this medicine.", ru_ex: "Мне нужен рецепт на это лекарство." },
            { t: "Здоров'я", no: "die Versicherung", uk: "страхування", en: "insurance", ru: "страховка", ex_no: "Es ist klug, eine Reiseversicherung zu haben.", ex_uk: "Розумно мати туристичну страховку.", en_ex: "It's wise to have travel insurance.", ru_ex: "Разумно иметь туристическую страховку." },
            { t: "Здоров'я", no: "der Impfstoff", uk: "вакцина", en: "vaccine", ru: "вакцина", ex_no: "Kinder bekommen diesen Impfstoff kostenlos.", ex_uk: "Діти отримують цю вакцину безкоштовно.", en_ex: "Children get this vaccine for free.", ru_ex: "Дети получают эту вакцину бесплатно." },
            // Relationships
            { t: "Стосунки", no: "der Partner", uk: "партнер", en: "partner", ru: "партнёр", ex_no: "Ich habe meinen Partner meiner Familie vorgestellt.", ex_uk: "Я познайомив свого партнера з родиною.", en_ex: "I introduced my partner to my family.", ru_ex: "Я познакомил своего партнёра с семьёй." },
            { t: "Стосунки", no: "die Ehe", uk: "шлюб", en: "marriage", ru: "брак", ex_no: "Sie haben zehn Jahre Ehe gefeiert.", ex_uk: "Вони відсвяткували десять років шлюбу.", en_ex: "They celebrated ten years of marriage.", ru_ex: "Они отпраздновали десять лет брака." },
            { t: "Стосунки", no: "das Vertrauen", uk: "довіра", en: "trust", ru: "доверие", ex_no: "Vertrauen ist wichtig in einer Beziehung.", ex_uk: "Довіра важлива у стосунках.", en_ex: "Trust is important in a relationship.", ru_ex: "Доверие важно в отношениях." },
            // Media
            { t: "Медіа", no: "die Nachrichten", uk: "новини", en: "news", ru: "новости", ex_no: "Ich schaue jeden Abend die Nachrichten.", ex_uk: "Я дивлюся новини щовечора.", en_ex: "I watch the news every evening.", ru_ex: "Я смотрю новости каждый вечер." },
            { t: "Медіа", no: "die Zeitung", uk: "газета", en: "newspaper", ru: "газета", ex_no: "Er liest morgens die Zeitung.", ex_uk: "Він читає газету вранці.", en_ex: "He reads the newspaper in the morning.", ru_ex: "Он читает газету утром." },
            { t: "Медіа", no: "soziale Medien", uk: "соціальні мережі", en: "social media", ru: "социальные сети", ex_no: "Junge Leute verbringen Zeit in sozialen Medien.", ex_uk: "Молодь проводить час у соціальних мережах.", en_ex: "Young people spend time on social media.", ru_ex: "Молодёжь проводит время в социальных сетях." },
            { t: "Медіа", no: "der Podcast", uk: "подкаст", en: "podcast", ru: "подкаст", ex_no: "Ich höre Podcasts, während ich trainiere.", ex_uk: "Я слухаю подкасти під час тренування.", en_ex: "I listen to podcasts while exercising.", ru_ex: "Я слушаю подкасты во время тренировки." },
            // Environment
            { t: "Довкілля", no: "die Umwelt", uk: "довкілля", en: "environment", ru: "окружающая среда", ex_no: "Wir müssen die Umwelt schützen.", ex_uk: "Ми повинні захищати довкілля.", en_ex: "We must protect the environment.", ru_ex: "Мы должны защищать окружающую среду." },
            { t: "Довкілля", no: "das Klima", uk: "клімат", en: "climate", ru: "климат", ex_no: "Der Klimawandel ist ein globales Problem.", ex_uk: "Зміна клімату — глобальна проблема.", en_ex: "Climate change is a global problem.", ru_ex: "Изменение климата — глобальная проблема." },
            { t: "Довкілля", no: "die Verschmutzung", uk: "забруднення", en: "pollution", ru: "загрязнение", ex_no: "Die Verschmutzung schadet der Tierwelt.", ex_uk: "Забруднення шкодить дикій природі.", en_ex: "Pollution harms wildlife.", ru_ex: "Загрязнение вредит дикой природе." },
            { t: "Довкілля", no: "das Recycling", uk: "переробка", en: "recycling", ru: "переработка", ex_no: "Recycling ist wichtig.", ex_uk: "Переробка важлива.", en_ex: "Recycling is important.", ru_ex: "Переработка важна." },
            { t: "Довкілля", no: "der Müll", uk: "відходи", en: "waste", ru: "отходы", ex_no: "Wir sortieren den Müll in Kategorien.", ex_uk: "Ми сортуємо сміття за категоріями.", en_ex: "We sort waste into categories.", ru_ex: "Мы сортируем отходы по категориям." },
            // Verbs
            { t: "Дієслова", no: "verstehen", uk: "розуміти", en: "understand", ru: "понимать", ex_no: "Ich verstehe nicht, was du meinst.", ex_uk: "Я не розумію, що ти маєш на увазі.", en_ex: "I don't understand what you mean.", ru_ex: "Я не понимаю, что ты имеешь в виду." },
            { t: "Дієслова", no: "erklären", uk: "пояснювати", en: "explain", ru: "объяснять", ex_no: "Kannst du die Regel noch einmal erklären?", ex_uk: "Можеш пояснити правило ще раз?", en_ex: "Can you explain the rule again?", ru_ex: "Можешь объяснить правило ещё раз?" },
            { t: "Дієслова", no: "glauben", uk: "вірити", en: "believe", ru: "верить", ex_no: "Ich glaube, sie hat recht.", ex_uk: "Я вірю, що вона має рацію.", en_ex: "I believe she is right.", ru_ex: "Я верю, что она права." },
            { t: "Дієслова", no: "versuchen", uk: "пробувати", en: "try", ru: "пытаться", ex_no: "Ich versuche, Deutsch zu lernen.", ex_uk: "Я намагаюся вивчити німецьку.", en_ex: "I'm trying to learn German.", ru_ex: "Я пытаюсь выучить немецкий." },
            { t: "Дієслова", no: "entscheiden", uk: "вирішувати", en: "decide", ru: "решать", ex_no: "Ich habe beschlossen, nach Berlin zu ziehen.", ex_uk: "Я вирішив переїхати до Берліна.", en_ex: "I decided to move to Berlin.", ru_ex: "Я решил переехать в Берлин." },
            { t: "Дієслова", no: "vermeiden", uk: "уникати", en: "avoid", ru: "избегать", ex_no: "Wir sollten Risiken vermeiden.", ex_uk: "Нам слід уникати ризиків.", en_ex: "We should avoid risks.", ru_ex: "Нам следует избегать рисков." },
            // Career
            { t: "Кар'єра", no: "die Karriere", uk: "кар'єра", en: "career", ru: "карьера", ex_no: "Sie hat eine erfolgreiche Karriere.", ex_uk: "Вона має успішну кар'єру.", en_ex: "She has a successful career.", ru_ex: "У неё успешная карьера." },
            { t: "Кар'єра", no: "das Vorstellungsgespräch", uk: "співбесіда", en: "interview", ru: "собеседование", ex_no: "Das Vorstellungsgespräch ist gut gelaufen.", ex_uk: "Співбесіда пройшла добре.", en_ex: "The interview went well.", ru_ex: "Собеседование прошло хорошо." },
            { t: "Кар'єра", no: "der Kollege", uk: "колега", en: "colleague", ru: "коллега", ex_no: "Meine Kollegen sind freundlich.", ex_uk: "Мої колеги привітні.", en_ex: "My colleagues are friendly.", ru_ex: "Мои коллеги приветливы." },
            { t: "Кар'єра", no: "die Bewerbung", uk: "заявка", en: "application", ru: "заявка", ex_no: "Ich habe meine Bewerbung gestern eingereicht.", ex_uk: "Я подав заявку вчора.", en_ex: "I submitted my application yesterday.", ru_ex: "Я подал заявку вчера." },
        ],

        // -------------------- B2 --------------------
        B2: [
            // Politics
            { t: "Політика", no: "die Regierung", uk: "уряд", en: "government", ru: "правительство", ex_no: "Die Regierung hat einen neuen Haushalt vorgelegt.", ex_uk: "Уряд представив новий бюджет.", en_ex: "The government presented a new budget.", ru_ex: "Правительство представило новый бюджет." },
            { t: "Політика", no: "die Wahl", uk: "вибори", en: "election", ru: "выборы", ex_no: "Die Wahl ist nächsten Monat.", ex_uk: "Вибори наступного місяця.", en_ex: "The election is next month.", ru_ex: "Выборы в следующем месяце." },
            { t: "Політика", no: "die Demokratie", uk: "демократія", en: "democracy", ru: "демократия", ex_no: "Die Meinungsfreiheit ist ein Grundpfeiler der Demokratie.", ex_uk: "Свобода слова — основа демократії.", en_ex: "Freedom of speech is a cornerstone of democracy.", ru_ex: "Свобода слова — основа демократии." },
            { t: "Політика", no: "die Opposition", uk: "опозиція", en: "opposition", ru: "оппозиция", ex_no: "Die Opposition hat den Vorschlag kritisiert.", ex_uk: "Опозиція розкритикувала пропозицію.", en_ex: "The opposition criticized the proposal.", ru_ex: "Оппозиция раскритиковала предложение." },
            // Economy
            { t: "Економіка", no: "die Wirtschaft", uk: "економіка", en: "economy", ru: "экономика", ex_no: "Die Wirtschaft wächst langsam.", ex_uk: "Економіка зростає повільно.", en_ex: "The economy is growing slowly.", ru_ex: "Экономика растёт медленно." },
            { t: "Економіка", no: "der Markt", uk: "ринок", en: "market", ru: "рынок", ex_no: "Der Markt hat auf die Nachricht reagiert.", ex_uk: "Ринок відреагував на новину.", en_ex: "The market reacted to the news.", ru_ex: "Рынок отреагировал на новость." },
            { t: "Економіка", no: "die Inflation", uk: "інфляція", en: "inflation", ru: "инфляция", ex_no: "Die Inflation ist stark gestiegen.", ex_uk: "Інфляція різко зросла.", en_ex: "Inflation has risen sharply.", ru_ex: "Инфляция резко выросла." },
            { t: "Економіка", no: "die Investition", uk: "інвестиція", en: "investment", ru: "инвестиция", ex_no: "Langfristige Investitionen sind wichtig.", ex_uk: "Довгострокові інвестиції важливі.", en_ex: "Long-term investment is important.", ru_ex: "Долгосрочные инвестиции важны." },
            // Science
            { t: "Наука", no: "die Forschung", uk: "дослідження", en: "research", ru: "исследование", ex_no: "Neue Forschung zeigt überraschende Ergebnisse.", ex_uk: "Нове дослідження показує несподівані результати.", en_ex: "New research shows surprising results.", ru_ex: "Новое исследование показывает неожиданные результаты." },
            { t: "Наука", no: "die Theorie", uk: "теорія", en: "theory", ru: "теория", ex_no: "Die Theorie wurde durch Experimente bestätigt.", ex_uk: "Теорію підтвердили експерименти.", en_ex: "The theory was confirmed by experiments.", ru_ex: "Теорию подтвердили эксперименты." },
            { t: "Наука", no: "das Experiment", uk: "експеримент", en: "experiment", ru: "эксперимент", ex_no: "Sie führten ein kontrolliertes Experiment durch.", ex_uk: "Вони провели контрольований експеримент.", en_ex: "They conducted a controlled experiment.", ru_ex: "Они провели контролируемый эксперимент." },
            { t: "Наука", no: "die Daten", uk: "дані", en: "data", ru: "данные", ex_no: "Die Daten wurden über mehrere Monate gesammelt.", ex_uk: "Дані збирали протягом кількох місяців.", en_ex: "Data was collected over several months.", ru_ex: "Данные собирали в течение нескольких месяцев." },
            // Culture
            { t: "Культура", no: "die Kunst", uk: "мистецтво", en: "art", ru: "искусство", ex_no: "Die Ausstellung zeigt moderne Kunst.", ex_uk: "Виставка демонструє сучасне мистецтво.", en_ex: "The exhibition shows modern art.", ru_ex: "Выставка демонстрирует современное искусство." },
            { t: "Культура", no: "die Literatur", uk: "література", en: "literature", ru: "литература", ex_no: "Sie studiert deutsche Literatur.", ex_uk: "Вона вивчає німецьку літературу.", en_ex: "She studies German literature.", ru_ex: "Она изучает немецкую литературу." },
            { t: "Культура", no: "der Autor", uk: "автор", en: "author", ru: "автор", ex_no: "Der Autor hat Anerkennung erhalten.", ex_uk: "Автор отримав визнання.", en_ex: "The author received recognition.", ru_ex: "Автор получил признание." },
            // Verbs
            { t: "Дієслова", no: "beeinflussen", uk: "впливати", en: "influence", ru: "влиять", ex_no: "Die Medien beeinflussen die öffentliche Meinung.", ex_uk: "ЗМІ впливають на громадську думку.", en_ex: "The media influences public opinion.", ru_ex: "СМИ влияют на общественное мнение." },
            { t: "Дієслова", no: "bewerten", uk: "оцінювати", en: "assess", ru: "оценивать", ex_no: "Wir müssen die Situation bewerten.", ex_uk: "Нам потрібно оцінити ситуацію.", en_ex: "We need to assess the situation.", ru_ex: "Нам нужно оценить ситуацию." },
            { t: "Дієслова", no: "entwickeln", uk: "розвивати", en: "develop", ru: "развивать", ex_no: "Das Unternehmen entwickelt neue Produkte.", ex_uk: "Компанія розробляє нові продукти.", en_ex: "The company is developing new products.", ru_ex: "Компания разрабатывает новые продукты." },
            { t: "Дієслова", no: "präsentieren", uk: "представляти", en: "present", ru: "представлять", ex_no: "Sie hat die Ergebnisse dem Vorstand präsentiert.", ex_uk: "Вона представила результати правлінню.", en_ex: "She presented the results to the board.", ru_ex: "Она представила результаты правлению." },
            { t: "Дієслова", no: "analysieren", uk: "аналізувати", en: "analyze", ru: "анализировать", ex_no: "Wir müssen die Daten analysieren.", ex_uk: "Нам потрібно проаналізувати дані.", en_ex: "We need to analyze the data.", ru_ex: "Нам нужно проанализировать данные." },
            // Business
            { t: "Бізнес", no: "das Unternehmen", uk: "підприємство", en: "business", ru: "бизнес", ex_no: "Das Unternehmen läuft dieses Jahr gut.", ex_uk: "Цього року бізнес іде добре.", en_ex: "Business is going well this year.", ru_ex: "В этом году бизнес идёт хорошо." },
            { t: "Бізнес", no: "die Strategie", uk: "стратегія", en: "strategy", ru: "стратегия", ex_no: "Wir brauchen eine neue Strategie.", ex_uk: "Нам потрібна нова стратегія.", en_ex: "We need a new strategy.", ru_ex: "Нам нужна новая стратегия." },
            { t: "Бізнес", no: "der Wettbewerb", uk: "конкуренція", en: "competition", ru: "конкуренция", ex_no: "Der Wettbewerb ist hart.", ex_uk: "Конкуренція є жорсткою.", en_ex: "Competition is intense.", ru_ex: "Конкуренция жёсткая." },
            // Medicine
            { t: "Медицина", no: "das Symptom", uk: "симптом", en: "symptom", ru: "симптом", ex_no: "Fieber ist ein häufiges Symptom.", ex_uk: "Температура — поширений симптом.", en_ex: "Fever is a common symptom.", ru_ex: "Температура — распространённый симптом." },
            { t: "Медицина", no: "chronisch", uk: "хронічний", en: "chronic", ru: "хронический", ex_no: "Er hat eine chronische Krankheit.", ex_uk: "Він має хронічну хворобу.", en_ex: "He has a chronic illness.", ru_ex: "У него хроническое заболевание." },
            { t: "Медицина", no: "die Epidemie", uk: "епідемія", en: "epidemic", ru: "эпидемия", ex_no: "Die Epidemie breitete sich schnell aus.", ex_uk: "Епідемія швидко поширилася.", en_ex: "The epidemic spread quickly.", ru_ex: "Эпидемия быстро распространилась." },
            { t: "Медицина", no: "die Prävention", uk: "профілактика", en: "prevention", ru: "профилактика", ex_no: "Prävention ist besser als Heilung.", ex_uk: "Профілактика краща за лікування.", en_ex: "Prevention is better than cure.", ru_ex: "Профилактика лучше лечения." },
        ],

        // -------------------- C1 --------------------
        C1: [
            // Discourse
            { t: "Дискурс", no: "jedoch", uk: "однак", en: "however", ru: "однако", ex_no: "Die Ergebnisse waren vielversprechend; jedoch gibt es noch viel zu tun.", ex_uk: "Результати були обнадійливі; однак роботи ще багато.", en_ex: "The results were promising; however, there is still work to do.", ru_ex: "Результаты были обнадёживающими; однако работы ещё много." },
            { t: "Дискурс", no: "außerdem", uk: "крім того", en: "moreover", ru: "кроме того", ex_no: "Das Projekt ist teuer und außerdem zeitaufwändig.", ex_uk: "Проєкт дорогий, і до того ж забирає багато часу.", en_ex: "The project is expensive, and moreover time-consuming.", ru_ex: "Проект дорогой, и к тому же отнимает много времени." },
            { t: "Дискурс", no: "folglich", uk: "отже", en: "consequently", ru: "следовательно", ex_no: "Die Nachfrage sank, und folglich fielen die Preise.", ex_uk: "Попит впав, і ціни, відповідно, знизилися.", en_ex: "Demand fell, and prices consequently dropped.", ru_ex: "Спрос упал, и цены, соответственно, снизились." },
            { t: "Дискурс", no: "trotz", uk: "незважаючи на", en: "despite", ru: "несмотря на", ex_no: "Trotz der Schwierigkeiten haben sie das Projekt abgeschlossen.", ex_uk: "Незважаючи на труднощі, вони завершили проєкт.", en_ex: "Despite the challenges, they completed the project.", ru_ex: "Несмотря на трудности, они завершили проект." },
            { t: "Дискурс", no: "mit anderen Worten", uk: "іншими словами", en: "in other words", ru: "другими словами", ex_no: "Mit anderen Worten, die Situation ist komplizierter.", ex_uk: "Іншими словами, ситуація складніша.", en_ex: "In other words, the situation is more complicated.", ru_ex: "Другими словами, ситуация сложнее." },
            // Nuance
            { t: "Нюанси", no: "andeuten", uk: "натякати", en: "imply", ru: "намекать", ex_no: "Der Bericht deutet an, dass mehrere Faktoren eine Rolle spielen.", ex_uk: "Звіт натякає, що діють кілька факторів.", en_ex: "The report implies that several factors are at play.", ru_ex: "Отчёт намекает, что действуют несколько факторов." },
            { t: "Нюанси", no: "betonen", uk: "підкреслювати", en: "emphasize", ru: "подчёркивать", ex_no: "Der Redner betonte die Bedeutung der Zusammenarbeit.", ex_uk: "Доповідач підкреслив важливість співпраці.", en_ex: "The speaker emphasized the importance of cooperation.", ru_ex: "Докладчик подчеркнул важность сотрудничества." },
            { t: "Нюанси", no: "untermauern", uk: "обґрунтовувати", en: "substantiate", ru: "обосновывать", ex_no: "Du musst deine Behauptung mit Beweisen untermauern.", ex_uk: "Тобі потрібно обґрунтувати своє твердження доказами.", en_ex: "You need to substantiate your claim with evidence.", ru_ex: "Тебе нужно обосновать своё утверждение доказательствами." },
            { t: "Нюанси", no: "differenziert", uk: "нюансований", en: "nuanced", ru: "нюансированный", ex_no: "Die Debatte erfordert einen differenzierteren Ansatz.", ex_uk: "Дебати потребують більш нюансованого підходу.", en_ex: "The debate requires a more nuanced approach.", ru_ex: "Дебаты требуют более нюансированного подхода." },
            { t: "Нюанси", no: "umfassend", uk: "всеохопний", en: "comprehensive", ru: "всеобъемлющий", ex_no: "Dies ist eine umfassende Studie.", ex_uk: "Це всеохопне дослідження.", en_ex: "This is a comprehensive study.", ru_ex: "Это всеобъемлющее исследование." },
            // Academic
            { t: "Академічна", no: "die Hypothese", uk: "гіпотеза", en: "hypothesis", ru: "гипотеза", ex_no: "Die Forscher haben die Hypothese getestet.", ex_uk: "Науковці перевірили гіпотезу.", en_ex: "The researchers tested the hypothesis.", ru_ex: "Учёные проверили гипотезу." },
            { t: "Академічна", no: "die Methodik", uk: "методологія", en: "methodology", ru: "методология", ex_no: "Die Methodik wird klar beschrieben.", ex_uk: "Методологія чітко описана.", en_ex: "The methodology is clearly described.", ru_ex: "Методология четко описана." },
            { t: "Академічна", no: "die Perspektive", uk: "перспектива", en: "perspective", ru: "перспектива", ex_no: "Aus historischer Perspektive war das Ereignis bedeutend.", ex_uk: "З історичної перспективи подія була значущою.", en_ex: "From a historical perspective, the event was significant.", ru_ex: "С исторической точки зрения событие было значимым." },
            { t: "Академічна", no: "die Quellenkritik", uk: "критика джерел", en: "source criticism", ru: "критика источников", ex_no: "Eine gute Quellenkritik ist entscheidend.", ex_uk: "Гарна критика джерел є вирішальною.", en_ex: "Good source criticism is crucial.", ru_ex: "Хорошая критика источников имеет решающее значение." },
            // Philosophy
            { t: "Філософія", no: "die Existenz", uk: "існування", en: "existence", ru: "существование", ex_no: "Die Frage nach der Existenz ist ewig.", ex_uk: "Питання про існування вічне.", en_ex: "The question of existence is eternal.", ru_ex: "Вопрос о существовании вечен." },
            { t: "Філософія", no: "das Bewusstsein", uk: "свідомість", en: "consciousness", ru: "сознание", ex_no: "Das Bewusstsein ist ein komplexes Phänomen.", ex_uk: "Свідомість — складне явище.", en_ex: "Consciousness is a complex phenomenon.", ru_ex: "Сознание — сложное явление." },
            { t: "Філософія", no: "die Ethik", uk: "етика", en: "ethics", ru: "этика", ex_no: "Ethik befasst sich mit dem, was richtig und falsch ist.", ex_uk: "Етика стосується того, що правильно, а що ні.", en_ex: "Ethics deals with what is right and wrong.", ru_ex: "Этика касается того, что правильно, а что нет." },
            // Linguistics
            { t: "Лінгвістика", no: "die Syntax", uk: "синтаксис", en: "syntax", ru: "синтаксис", ex_no: "Syntax ist die Lehre vom Satzbau.", ex_uk: "Синтаксис — це вивчення структури речень.", en_ex: "Syntax is the study of sentence structure.", ru_ex: "Синтаксис — это изучение структуры предложений." },
            { t: "Лінгвістика", no: "die Semantik", uk: "семантика", en: "semantics", ru: "семантика", ex_no: "Die Semantik befasst sich mit der Bedeutung.", ex_uk: "Семантика займається значенням.", en_ex: "Semantics deals with meaning.", ru_ex: "Семантика занимается значением." },
            // Sociology
            { t: "Соціологія", no: "die soziale Ungleichheit", uk: "соціальна нерівність", en: "social inequality", ru: "социальное неравенство", ex_no: "Soziale Ungleichheit ist ein großes Problem.", ex_uk: "Соціальна нерівність — велика проблема.", en_ex: "Social inequality is a major problem.", ru_ex: "Социальное неравенство — большая проблема." },
            { t: "Соціологія", no: "die Integration", uk: "інтеграція", en: "integration", ru: "интеграция", ex_no: "Die Integration von Einwanderern ist wichtig.", ex_uk: "Інтеграція іммігрантів важлива.", en_ex: "Integration of immigrants is important.", ru_ex: "Интеграция иммигрантов важна." },
            { t: "Соціологія", no: "die Vielfalt", uk: "різноманіття", en: "diversity", ru: "разнообразие", ex_no: "Vielfalt bereichert die Gesellschaft.", ex_uk: "Різноманіття збагачує суспільство.", en_ex: "Diversity enriches society.", ru_ex: "Разнообразие обогащает общество." },
            // Psychology
            { t: "Психологія", no: "die Kognition", uk: "когніція", en: "cognition", ru: "когниция", ex_no: "Kognition umfasst Denken und Gedächtnis.", ex_uk: "Когніція охоплює мислення та пам'ять.", en_ex: "Cognition includes thinking and memory.", ru_ex: "Когниция охватывает мышление и память." },
            { t: "Психологія", no: "die Emotion", uk: "емоція", en: "emotion", ru: "эмоция", ex_no: "Emotionen beeinflussen unsere Entscheidungen.", ex_uk: "Емоції впливають на наш вибір.", en_ex: "Emotions influence our choices.", ru_ex: "Эмоции влияют на наш выбор." },
            { t: "Психологія", no: "das Verhalten", uk: "поведінка", en: "behavior", ru: "поведение", ex_no: "Sein Verhalten war unerwartet.", ex_uk: "Його поведінка була несподіваною.", en_ex: "His behavior was unexpected.", ru_ex: "Его поведение было неожиданным." },
            { t: "Психологія", no: "die Motivation", uk: "мотивація", en: "motivation", ru: "мотивация", ex_no: "Motivation kommt von innen.", ex_uk: "Мотивація походить зсередини.", en_ex: "Motivation comes from within.", ru_ex: "Мотивация исходит изнутри." },
        ],
        ...
        C2: [
            ...
            { t: "Ідіоми", no: "Perlen vor die Säue werfen", uk: "метати бісер перед свинями", en: "to cast pearls before swine", ru: "метать бисер перед свиньями", ex_no: "Ihm das zu erklären ist wie Perlen vor die Säue zu werfen.", ex_uk: "Пояснювати йому це — все одно що метати бісер перед свинями.", en_ex: "Explaining it to him is like casting pearls before swine.", ru_ex: "Объяснять ему это — всё равно что метать бисер перед свиньями." },
            { t: "Ідіоми", no: "großen Einfluss haben", uk: "мати великий вплив", en: "to hold great sway", ru: "иметь большое влияние", ex_no: "Er hat großen Einfluss in der Branche.", ex_uk: "Він має величезний вплив у галузі.", en_ex: "He holds great sway in the industry.", ru_ex: "Он имеет большое влияние в отрасли." },
            { t: "Ідіоми", no: "ein düsteres Bild malen", uk: "згущувати фарби", en: "to paint a bleak picture", ru: "сгущать краски", ex_no: "Male kein düsteres Bild; es wird sich schon regeln.", ex_uk: "Не згущуй фарби; все владнається.", en_ex: "Don't paint a bleak picture; it'll work out.", ru_ex: "Не сгущай краски; всё уладится." },
            { t: "Ідіоми", no: "das Handtuch werfen", uk: "здатися", en: "to throw in the towel", ru: "сдаться", ex_no: "Nach mehreren Niederlagen warf er das Handtuch.", ex_uk: "Після кількох поразок він здався.", en_ex: "After several defeats, he threw in the towel.", ru_ex: "После нескольких поражений он сдался." },
            // Stylistics
            { t: "Стилістика", no: "die Fiktion", uk: "художня література", en: "fiction", ru: "художественная литература", ex_no: "Sie bevorzugt Fiktion gegenüber Sachbüchern.", ex_uk: "Вона надає перевагу художній літературі перед науковою.", en_ex: "She prefers fiction to non-fiction.", ru_ex: "Она предпочитает художественную литературу научной." },
            { t: "Стилістика", no: "die Satire", uk: "сатира", en: "satire", ru: "сатира", ex_no: "Die Sendung nutzt Satire, um Politik zu kommentieren.", ex_uk: "Шоу використовує сатиру для коментування політики.", en_ex: "The show uses satire to comment on politics.", ru_ex: "Шоу использует сатиру для комментирования политики." },
            { t: "Стилістика", no: "die Ironie", uk: "іронія", en: "irony", ru: "ирония", ex_no: "Sein Kommentar war ironisch gemeint.", ex_uk: "Його коментар був іронією.", en_ex: "His comment was ironic.", ru_ex: "Его комментарий был иронией." },
            // Rare vocabulary
            { t: "Рідкісна лексика", no: "vergänglich", uk: "минущий", en: "transient", ru: "преходящий", ex_no: "Ruhm kann vergänglich sein.", ex_uk: "Слава може бути минущою.", en_ex: "Fame can be transient.", ru_ex: "Слава может быть преходящей." },
            { t: "Рідкісна лексика", no: "unberechenbar", uk: "непередбачуваний", en: "unpredictable", ru: "непредсказуемый", ex_no: "Das Wetter ist unberechenbar.", ex_uk: "Погода непередбачувана.", en_ex: "The weather is unpredictable.", ru_ex: "Погода непредсказуема." },
            { t: "Рідкісна лексика", no: "unvermeidlich", uk: "неминучий", en: "inevitable", ru: "неизбежный", ex_no: "Der Konflikt schien unvermeidlich.", ex_uk: "Конфлікт здавався неминучим.", en_ex: "The conflict seemed inevitable.", ru_ex: "Конфликт казался неизбежным." },
            // Rhetoric
            { t: "Риторика", no: "die Rhetorik", uk: "риторика", en: "rhetoric", ru: "риторика", ex_no: "Rhetorik ist die Kunst der Überzeugung.", ex_uk: "Риторика — це мистецтво переконання.", en_ex: "Rhetoric is the art of persuasion.", ru_ex: "Риторика — это искусство убеждения." },
            { t: "Риторика", no: "die Argumentation", uk: "аргументація", en: "argumentation", ru: "аргументация", ex_no: "Seine Argumentation war solide.", ex_uk: "Його аргументація була вагомою.", en_ex: "His argumentation was solid.", ru_ex: "Его аргументация была убедительной." },
            { t: "Риторика", no: "der Appell", uk: "звернення", en: "appeal", ru: "апелляция", ex_no: "Der Appell an die Emotionen war stark.", ex_uk: "Звернення до емоцій було сильним.", en_ex: "The appeal to emotions was strong.", ru_ex: "Обращение к эмоциям было сильным." },
            // Literary
            { t: "Літературознавство", no: "das Motiv", uk: "мотив", en: "motif", ru: "мотив", ex_no: "Die Liebe ist ein zentrales Motiv im Buch.", ex_uk: "Кохання — центральний мотив у книзі.", en_ex: "Love is a central motif in the book.", ru_ex: "Любовь — центральный мотив в книге." },
            { t: "Літературознавство", no: "das Thema", uk: "тема", en: "theme", ru: "тема", ex_no: "Das Thema des Romans ist die Einsamkeit.", ex_uk: "Тема роману — самотність.", en_ex: "The theme of the novel is loneliness.", ru_ex: "Тема романа — одиночество." },
            { t: "Літературознавство", no: "die Symbolik", uk: "символіка", en: "symbolism", ru: "символика", ex_no: "Das Gedicht ist reich an Symbolik.", ex_uk: "Вірш багатий на символіку.", en_ex: "The poem is rich in symbolism.", ru_ex: "Стихотворение богато на символику." },
            // Abstract
            { t: "Абстрактне", no: "der Kontrast", uk: "контраст", en: "contrast", ru: "контраст", ex_no: "Der Kontrast zwischen Arm und Reich ist groß.", ex_uk: "Контраст між багатими та бідними великий.", en_ex: "The contrast between rich and poor is stark.", ru_ex: "Контраст между богатыми и бедными велик." },
            { t: "Абстрактне", no: "ausschließen", uk: "виключати", en: "exclude", ru: "исключать", ex_no: "Wir dürfen niemanden ausschließen.", ex_uk: "Ми не повинні нікого виключати.", en_ex: "We must not exclude anyone.", ru_ex: "Мы не должны никого исключать." },
            { t: "Абстрактне", no: "einschließen", uk: "включати", en: "include", ru: "включать", ex_no: "Alle sollten eingeschlossen werden.", ex_uk: "Усі повинні бути включені.", en_ex: "Everyone should be included.", ru_ex: "Все должны быть включены." },
            { t: "Абстрактне", no: "der Kontext", uk: "контекст", en: "context", ru: "контекст", ex_no: "Ohne Kontext ist es schwer zu verstehen.", ex_uk: "Без контексту важко зрозуміти.", en_ex: "Without context, it's hard to understand.", ru_ex: "Без контекста трудно понять." },
            { t: "Абстрактне", no: "widerspiegeln", uk: "відображати", en: "reflect", ru: "отражать", ex_no: "Das Gespräch spiegelt den gesellschaftlichen Wandel wider.", ex_uk: "Розмова відображає соціальні зміни.", en_ex: "The conversation reflects social changes.", ru_ex: "Разговор отражает социальные изменения." },
            { t: "Абстрактне", no: "ausführen", uk: "деталізувати", en: "elaborate", ru: "детализировать", ex_no: "Kannst du diesen Punkt näher ausführen?", ex_uk: "Можеш детальніше розкрити цей пункт?", en_ex: "Can you elaborate on that point?", ru_ex: "Можешь детальнее раскрыть этот пункт?" },
        ],
    };
